...
# run otf
al_otf = otf.OTF(qe_input, dt, number_of_steps, kernel, bodies, cutoff,
                 pw_loc, std_tolerance_factor, opt_algo, par=True,
                 prev_pos_init=prev_pos_mod,
                 parsimony=True,
                 skip=100)
