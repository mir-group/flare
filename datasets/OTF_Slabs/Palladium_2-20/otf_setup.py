...
# make slab with ase
slab = fcc100(symbol, size, a=alat, vacuum=vacuum)
add_adsorbate(slab, symbol, height, 'bridge')
...
ion_names = ['Pd']
ion_masses = [mass]
ion_pseudo = ['Pd.pbe-n-kjpaw_psl.1.0.0.UPF']
kvec = np.array([4, 4, 2])
ecutwfc = 36  # minimum recommended
ecutrho = 448  # minimum recommended
