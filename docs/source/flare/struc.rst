...
.. py:class:: Structure(
    cell: np.array, species: List[str] or List[int], positions: np.array,
    mass_dict: dict = {}, prev_positions: ndarray = [],
    ...
    :param positions: Nx3 array of atomic coordinates in A.
