...
from flare.predict import predict_on_structure, predict_on_structure_par,\
        predict_on_atom, predict_on_atom_en, predict_on_structure_en,\
...
def fake_predict_local_energy(x):
...
@pytest.mark.parametrize(['write_to_structure','selective_atoms'],[(True,[]),
                                                                  (True,[1]),
                                                                  (False,[]),
                                                                  (False,[1])])
