...
TEST_F(CompactStructureTest, TestKernel){
    ...
    // std::cout << struc2.local_environments[0].environment_indices.size() << std::endl;

    std::cout << kern_vec << std::endl;

    // std::cout << "Force dervs:" << std::endl;
    // std::cout << test_struc.descriptor_force_dervs[0](0, 1000) << std::endl;
    // std::cout << struc2.local_environments[0].descriptor_force_dervs[0](3, 1000) << std::endl;

    // std::cout << "Force dot:" << std::endl;
    // std::cout << test_struc.descriptor_force_dots[0] << std::endl;
    // std::cout << "Force dot:" << std::endl;
    // std::cout << struc2.local_environments[0].force_dot[0] << std::endl;
}

// TEST(MatTest, MatTest){
//     Eigen::MatrixXd test = Eigen::MatrixXd::Zero(3, 3);
...
//     std::cout << test * test.row(0).transpose() << std::endl;
// }
