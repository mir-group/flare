...
def test_force_en_v2():
    ...
    v1_kern = en.three_body_cons_quad_force_en(env1, env2, d1,
                                               hyps, cutoffs)
...
def test_three_body_grad_v2():
    ...
    v1_kern = en.three_body_cons_quad_grad(env1, env2, d1, d2,
                                           hyps, cutoffs)
...
def test_three_body_v2():
    ...
    v1_kern = en.three_body_cons_quad(env1, env2, d1, d2,
                                      hyps, cutoffs)
...
def test_three_body_derv():
    ...
    grad_test = en.three_body_cons_quad_grad(env1, env2,
                                             d1, d2, hyps, cutoffs)
    ...
    sig_derv_brute = (en.three_body_cons_quad(env1, env2, d1, d2,
                                              np.array([new_sig, ls]),
                                              cutoffs) -
                      en.three_body_cons_quad(env1, env2, d1, d2,
                                              hyps, cutoffs)) / delta

    l_derv_brute = (en.three_body_cons_quad(env1, env2, d1, d2,
                                            np.array([sig, new_ls]),
                                            cutoffs) -
                    en.three_body_cons_quad(env1, env2, d1, d2,
                                            hyps, cutoffs)) / delta
...
def test_three_body_force_en():
    ...
    # check force kernel
    calc1 = en.three_body_cons_quad_en(env1_2, env2, hyps, cutoffs)
    calc2 = en.three_body_cons_quad_en(env1_1, env2, hyps, cutoffs)

    kern_finite_diff = (calc1 - calc2) / delt
    kern_analytical = en.three_body_cons_quad_force_en(env1_1, env2,
                                                       d1, hyps, cutoffs)
...
def test_three_body_cons():
    ...
    # check force kernel
    calc1 = en.three_body_cons_quad_en(env1_2, env2_2, hyps, cutoffs)
    calc2 = en.three_body_cons_quad_en(env1_3, env2_3, hyps, cutoffs)
    calc3 = en.three_body_cons_quad_en(env1_2, env2_3, hyps, cutoffs)
    calc4 = en.three_body_cons_quad_en(env1_3, env2_2, hyps, cutoffs)

    kern_finite_diff = (calc1 + calc2 - calc3 - calc4) / (4*delt**2)
    kern_analytical = en.three_body_cons_quad(env1_1, env2_1,
                                              d1, d2, hyps, cutoffs)
