...
def test_force_en(kernel_array, kernel_type):
    ...
    hyps = generate_hm(kernel_array)

    _, __, en_kernel, force_en_kernel = \
        str_to_kernel_set(kernel_array, kernel_type)
...
@pytest.mark.parametrize('kernel_array', list_to_test)
@pytest.mark.parametrize('kernel_type', list_type)
def test_force(kernel_array, kernel_type):
...
@pytest.mark.parametrize('kernel_array', list_to_test)
@pytest.mark.parametrize('kernel_type', list_type)
def test_hyps_grad(kernel_array, kernel_type):
    ...
    kernel, kernel_grad, _, _ = str_to_kernel_set(kernel_array, kernel_type)
