...
#     two_body_new = kernels.n_body_sc(env1, env2, d1, d2, hyps)
...
#     three_body_new = kernels.n_body_sc(env1, env2, d1, d2, hyps, bodies=3)
...
#     three_body_mc = kernels.n_body_sc(env1, env2, d1, d2, hyps, bodies=3)
...
#     bodies = 4
#     _, kern_grad = kernels.n_body_sc_grad(env1, env2, d1, d2, hyps,
#                                           bodies=bodies)
...
#     sig_derv_brute = (kernels.n_body_sc(env1, env2, d1, d2,
#                       np.array([new_sig, ls]), bodies=bodies) -
#                       kernels.n_body_sc(env1, env2, d1, d2,
#                                         hyps, bodies=bodies)) / delta

#     l_derv_brute = (kernels.n_body_sc(env1, env2, d1, d2,
#                                       np.array([sig, new_ls]),
#                                       bodies=bodies) -
#                     kernels.n_body_sc(env1, env2, d1, d2,
#                                       hyps, bodies=bodies)) / delta
...
#     en_force_test = kernels.energy_force_sc(env1, env2, d1, hyps,
#                                             bodies=bodies)
#     en_force_test_2 = \
#         kernels.energy_force_sc(env1, delt_env, d1, hyps, bodies=bodies)
#     force_diff = (en_force_test_2-en_force_test)/delta

#     force_kern = kernels.n_body_sc(env1, env2, d1, d2, hyps, bodies=bodies)
...
#     en_force_test = kernels.energy_force_sc(env2, env1, d1, hyps,
#                                             bodies=bodies)
...
#     d2 = 1
#     hyps = np.array([1, 1, 1])
#     sc_grad = n_body_sc_grad(mc_env_1, mc_env_2, d1, d2, hyps, bodies=bodies)
