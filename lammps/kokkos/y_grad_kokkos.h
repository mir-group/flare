...
void get_Y_kokkos(int j, ViewType &Y, const double x, const double y, const double z, const int l) {
  ...
  { // l_counter == 1
    Y(j,counter,0) = (c1 * y) / (2. * r2s);
    Y(j,counter,1) = -(c1 * x * y) / (2. * r3);
    Y(j,counter,2) = (c1 * (x2 + z2)) / (2. * r3);
    Y(j,counter,3) = -(c1 * y * z) / (2. * r3);
    counter++;

    Y(j,counter,0) = (c1 * z) / (2. * r2s);
    Y(j,counter,1) = -(c1 * x * z) / (2. * r3);
    Y(j,counter,2) = -(c1 * y * z) / (2. * r3);
    Y(j,counter,3) = (c1 * x2py21) / (2. * r3);
    counter++;

    Y(j,counter,0) = (c1 * x) / (2. * r2s);
    Y(j,counter,1) = (c1 * (y2 + z2)) / (2. * r3);
    Y(j,counter,2) = -(c1 * x * y) / (2. * r3);
    Y(j,counter,3) = -(c1 * x * z) / (2. * r3);
    counter++;
  }
  if (l == 1)
    return;
  ...
  { // l_counter == 2
    Y(j,counter,0) = (c2 * x * y) / (2. * (r2));
    Y(j,counter,1) = (c2 * y * (-x2 + y2 + z2)) / (2. * r4);
    Y(j,counter,2) = (c2 * x * (x2 - y2 + z2)) / (2. * r4);
    Y(j,counter,3) = -((c2 * x * y * z) / r4);
    counter++;

    Y(j,counter,0) = (c2 * y * z) / (2. * (r2));
    Y(j,counter,1) = -((c2 * x * y * z) / r4);
    Y(j,counter,2) = (c2 * z * (x2 - y2 + z2)) / (2. * r4);
    Y(j,counter,3) = (c2 * y * (x2 + y2 - z2)) / (2. * r4);
    counter++;

    Y(j,counter,0) = -(c4 * (x2 + y2 - 2 * z2)) / (4. * (r2));
    Y(j,counter,1) = (-3 * c4 * x * z2) / (2. * r4);
    Y(j,counter,2) = (-3 * c4 * y * z2) / (2. * r4);
    Y(j,counter,3) = (3 * c4 * x2py21 * z) / (2. * r4);
    counter++;

    Y(j,counter,0) = (c2 * x * z) / (2. * (r2));
    Y(j,counter,1) = (c2 * z * (-x2 + y2 + z2)) / (2. * r4);
    Y(j,counter,2) = -((c2 * x * y * z) / r4);
    Y(j,counter,3) = (c2 * x * (x2 + y2 - z2)) / (2. * r4);
    counter++;

    Y(j,counter,0) = (c2 * (x - y) * (x + y)) / (4. * (r2));
    Y(j,counter,1) = (c2 * x * (2 * y2 + z2)) / (2. * r4);
    Y(j,counter,2) = -(c2 * y * (2 * x2 + z2)) / (2. * r4);
    Y(j,counter,3) = -(c2 * (x - y) * (x + y) * z) / (2. * r4);
    counter++;
  }
  if (l == 2)
    return;
  ...
  { // l_counter == 3
    Y(j,counter,0) = -(c3 * y * (-3 * x2 + y2)) / (4. * r3);
    Y(j,counter,1) = (-3 * c3 * x * y * (x2 - 3 * y2 - 2 * z2)) / (4. * r5);
    Y(j,counter,2) = (3 * c3 * (x4 - y2 * z2 + x2 * (-3 * y2 + z2))) / (4. * r5);
    Y(j,counter,3) = (3 * c3 * y * (-3 * x2 + y2) * z) / (4. * r5);
    counter++;

    Y(j,counter,0) = (c5 * x * y * z) / (2. * r3);
    Y(j,counter,1) = (c5 * y * z * (-2 * x2 + y2 + z2)) / (2. * r5);
    Y(j,counter,2) = (c5 * x * z * (x2 - 2 * y2 + z2)) / (2. * r5);
    Y(j,counter,3) = (c5 * x * y * (x2 + y2 - 2 * z2)) / (2. * r5);
    counter++;

    Y(j,counter,0) = -(c6 * y * (x2 + y2 - 4 * z2)) / (4. * r3);
    Y(j,counter,1) = (c6 * x * y * (x2 + y2 - 14 * z2)) / (4. * r5);
    Y(j,counter,2) =
        -(c6 * (x4 + 11 * y2 * z2 - 4 * z4 + x2 * (y2 - 3 * z2))) / (4. * r5);
    Y(j,counter,3) = (c6 * y * z * (11 * x2py21 - 4 * z2)) / (4. * r5);
    counter++;

    Y(j,counter,0) = (c7 * z * (-3 * x2py21 + 2 * z2)) / (4. * r3);
    Y(j,counter,1) = (3 * c7 * x * z * (x2 + y2 - 4 * z2)) / (4. * r5);
    Y(j,counter,2) = (3 * c7 * y * z * (x2 + y2 - 4 * z2)) / (4. * r5);
    Y(j,counter,3) = (-3 * c7 * x2py21 * (x2 + y2 - 4 * z2)) / (4. * r5);
    counter++;

    Y(j,counter,0) = -(c6 * x * (x2 + y2 - 4 * z2)) / (4. * r3);
    Y(j,counter,1) =
        -(c6 * (y4 - 3 * y2 * z2 - 4 * z4 + x2 * (y2 + 11 * z2))) / (4. * r5);
    Y(j,counter,2) = (c6 * x * y * (x2 + y2 - 14 * z2)) / (4. * r5);
    Y(j,counter,3) = (c6 * x * z * (11 * x2py21 - 4 * z2)) / (4. * r5);
    counter++;

    Y(j,counter,0) = (c5 * (x - y) * (x + y) * z) / (4. * r3);
    Y(j,counter,1) = -(c5 * x * z * (x2 - 5 * y2 - 2 * z2)) / (4. * r5);
    Y(j,counter,2) = (c5 * y * z * (-5 * x2 + y2 - 2 * z2)) / (4. * r5);
    Y(j,counter,3) = (c5 * (x - y) * (x + y) * (x2 + y2 - 2 * z2)) / (4. * r5);
    counter++;

    Y(j,counter,0) = (c3 * (x3 - 3 * xy2)) / (4. * r3);
    Y(j,counter,1) =
        (3 * c3 * (-(y2 * (y2 + z2)) + x2 * (3 * y2 + z2))) / (4. * r5);
    Y(j,counter,2) = (3 * c3 * x * y * (-3 * x2 + y2 - 2 * z2)) / (4. * r5);
    Y(j,counter,3) = (-3 * c3 * (x3 - 3 * xy2) * z) / (4. * r5);
    counter++;
  }
  if (l == 3)
    return;
  ...
  { // l_counter == 4
    Y(j,counter,0) = (3 * c9 * x * (x - y) * y * (x + y)) / (4. * r4);
    Y(j,counter,1) =
        (-3 * c9 * y * (x4 + y2 * (y2 + z2) - 3 * x2 * (2 * y2 + z2))) /
        (4. * r6);
    Y(j,counter,2) = (3 * c9 * x * (x4 + y4 - 3 * y2 * z2 + x2 * (-6 * y2 + z2))) /
                  (4. * r6);
    Y(j,counter,3) = (-3 * c9 * x * (x - y) * y * (x + y) * z) / r6;
    counter++;

    Y(j,counter,0) = (-3 * c3 * y * (-3 * x2 + y2) * z) / (4. * r4);
    Y(j,counter,1) =
    ...
    Y(j,counter,0) = (-3 * c4 * x * y * (x2 + y2 - 6 * z2)) / (4. * r4);
    Y(j,counter,1) =
        (3 * c4 * y * (x4 - y4 - 21 * x2 * z2 + 5 * y2 * z2 + 6 * z4)) /
        (4. * r6);
    Y(j,counter,2) = (3 * c4 * x * (-x4 + y4 + (5 * x2 - 21 * y2) * z2 + 6 * z4)) /
                  (4. * r6);
    Y(j,counter,3) = (3 * c4 * x * y * z * (4 * x2py21 - 3 * z2)) / r6;
    counter++;

    Y(j,counter,0) = (-3 * c8 * y * z * (3 * x2py21 - 4 * z2)) / (4. * r4);
    Y(j,counter,1) = (3 * c8 * x * y * z * (3 * x2py21 - 11 * z2)) / (2. * r6);
    Y(j,counter,2) =
    ...
    Y(j,counter,1) = (15 * x * z2 * (3 * x2py21 - 4 * z2)) / (4. * std::sqrt(Pi) * r6);
    Y(j,counter,2) = (15 * y * z2 * (3 * x2py21 - 4 * z2)) / (4. * std::sqrt(Pi) * r6);
    Y(j,counter,3) =
        (15 * x2py21 * z * (-3 * x2py21 + 4 * z2)) / (4. * std::sqrt(Pi) * r6);
    counter++;

    Y(j,counter,0) = (-3 * c8 * x * z * (3 * x2py21 - 4 * z2)) / (4. * r4);
    Y(j,counter,1) =
        (3 * c8 * z * (3 * x4 - 3 * y4 - 21 * x2 * z2 + y2 * z2 + 4 * z4)) /
        (4. * r6);
    Y(j,counter,2) = (3 * c8 * x * y * z * (3 * x2py21 - 11 * z2)) / (2. * r6);
    Y(j,counter,3) =
        (-3 * c8 * x * (3 * x2py2 - 21 * x2py21 * z2 + 4 * z4)) / (4. * r6);
    counter++;

    Y(j,counter,0) = (-3 * c4 * (x - y) * (x + y) * (x2 + y2 - 6 * z2)) / (8. * r4);
    Y(j,counter,1) =
    ...
    Y(j,counter,0) = (3 * c3 * (x3 - 3 * xy2) * z) / (4. * r4);
    Y(j,counter,1) =
        (-3 * c3 * z * (x4 + 3 * y2 * (y2 + z2) - 3 * x2 * (4 * y2 + z2))) /
        (4. * r6);
    Y(j,counter,2) =
        (-3 * c3 * x * y * z * (5 * x2 - 3 * y2 + 3 * z2)) / (2. * r6);
    Y(j,counter,3) = (3 * c3 * (x3 - 3 * xy2) * (x2 + y2 - 3 * z2)) / (4. * r6);
    counter++;

    Y(j,counter,0) = (3 * c9 * (x4 - 6 * x2 * y2 + y4)) / (16. * r4);
    Y(j,counter,1) =
        (3 * c9 * x * (-4 * y4 - 3 * y2 * z2 + x2 * (4 * y2 + z2))) / (4. * r6);
    Y(j,counter,2) =
        (3 * c9 * y * (-4 * x4 + y2 * z2 + x2 * (4 * y2 - 3 * z2))) / (4. * r6);
    Y(j,counter,3) = (-3 * c9 * (x4 - 6 * x2 * y2 + y4) * z) / (4. * r6);
    counter++;
  }
  if (l == 4)
    return;
  ...
  { // if l_counter == 5
    Y(j,counter,0) = (3 * c10 * (5 * x4 * y - 10 * x2 * y3 + y5)) / (16. * r5);
    Y(j,counter,1) = (-15 * c10 * x * y *
    ...
    Y(j,counter,0) = (3 * c11 * x * (x - y) * y * (x + y) * z) / (4. * r5);
    Y(j,counter,1) = (-3 * c11 * y * z *
    ...
    Y(j,counter,0) = (c12 * y * (-3 * x2 + y2) * (x2 + y2 - 8 * z2)) / (16. * r5);
    Y(j,counter,1) =
        (3 * c12 * x * y *
    ...
    Y(j,counter,2) = (-3 * c12 *
                  ...
                  (16. * r7);
    Y(j,counter,3) = (-3 * c12 * y * (-3 * x2 + y2) * z * (7 * x2py21 - 8 * z2)) /
                  (16. * r7);
    counter++;

    Y(j,counter,0) =
        -(std::sqrt(1155 / Pi) * x * y * z * (x2 + y2 - 2 * z2)) / (4. * r5);
    Y(j,counter,1) = (std::sqrt(1155 / Pi) * y * z *
                   (2 * x4 - y4 + y2 * z2 + 2 * z4 + x2 * (y2 - 11 * z2))) /
                  (4. * r7);
    Y(j,counter,2) = (std::sqrt(1155 / Pi) * x * z *
    ...
    Y(j,counter,2) =
        ...
        (8. * r7);
    Y(j,counter,3) = -(std::sqrt(1155 / Pi) * (x - y) * (x + y) *
                    (x2py2 - 10 * x2py21 * z2 + 4 * z4)) /
                  (8. * r7);
    counter++;

    Y(j,counter,0) = -(c12 * (x3 - 3 * xy2) * (x2 + y2 - 8 * z2)) / (16. * r5);
    Y(j,counter,1) = (-3 * c12 *
                   (-(y2 * (-3 * x2 + y2) * x2py21) +
                    7 * (x4 - 6 * x2 * y2 + y4) * z2 + 8 * (-x2 + y2) * z4)) /
                  (16. * r7);
    ...
    Y(j,counter,0) = (3 * c11 * (x4 - 6 * x2 * y2 + y4) * z) / (16. * r5);
    Y(j,counter,1) = (-3 * c11 * x * z *
                   (x4 - 22 * x2 * y2 + 17 * y4 - 4 * (x2 - 3 * y2) * z2)) /
                  (16. * r7);
    Y(j,counter,2) = (-3 * c11 * y * z *
    ...
    Y(j,counter,0) = (3 * c10 * (x5 - 10 * x3 * y2 + 5 * x * y4)) / (16. * r5);
    Y(j,counter,1) =
        (15 * c10 *
         (5 * x4 * y2 - 10 * x2 * y4 + y6 + (x4 - 6 * x2 * y2 + y4) * z2)) /
        (16. * r7);
    Y(j,counter,2) = (-15 * c10 * x * y *
  ...
  { // l_counter == 6
    Y(j,counter,0) =
        ...
        (16. * r6);
    Y(j,counter,1) = (3 * std::sqrt(3003 / two_pi) * y *
                   (-x6 + y4 * (y2 + z2) + 5 * x4 * (3 * y2 + z2) -
                    5 * x2 * (3 * y4 + 2 * y2 * z2))) /
                  (16. * r8);
    Y(j,counter,2) = (3 * std::sqrt(3003 / two_pi) * x *
                   (x6 - 15 * x4 * y2 + 15 * x2 * y4 - y6 +
                    (x4 - 10 * x2 * y2 + 5 * y4) * z2)) /
                  (16. * r8);
    Y(j,counter,3) = (-3 * std::sqrt(3003 / two_pi) *
    ...
    Y(j,counter,1) =
        ...
        (8. * r8);
    Y(j,counter,2) = (3 * std::sqrt(1001 / two_pi) * z *
                   (5 * x6 - 55 * x4 * y2 + 35 * x2 * y4 - y6 +
                    5 * (x4 - 6 * x2 * y2 + y4) * z2)) /
                  (16. * r8);
    Y(j,counter,3) = (3 * std::sqrt(1001 / two_pi) * (5 * x4 * y - 10 * x2 * y3 + y5) *
                   (x2 + y2 - 5 * z2)) /
                  (16. * r8);
    counter++;
    ...
    Y(j,counter,2) =
        ...
        (8. * r8);
    Y(j,counter,3) = (3 * std::sqrt(91 / Pi) * x * (x - y) * y * (x + y) * z *
                   (13 * x2py21 - 20 * z2)) /
                  (4. * r8);
    counter++;
    ...
    Y(j,counter,1) =
        ...
        (8. * r8);
    Y(j,counter,2) = (3 * std::sqrt(1365 / two_pi) * z *
                   (-3 * x6 + 9 * x4 * y2 + 11 * x2 * y4 - y6 +
                    (5 * x4 - 54 * x2 * y2 + 13 * y4) * z2 +
                    8 * (x - y) * (x + y) * z4)) /
                  (16. * r8);
    Y(j,counter,3) = (3 * std::sqrt(1365 / two_pi) * y * (-3 * x2 + y2) *
    ...
    Y(j,counter,2) =
        (std::sqrt(1365 / two_pi) * x *
         ((x - y) * (x + y) * x2py2 - (15 * x2 - 53 * y2) * x2py21 * z2 -
          128 * y2 * z4 + 16 * z6)) /
        (16. * r8);
    Y(j,counter,3) = -(std::sqrt(1365 / two_pi) * x * y * z *
    ...
    Y(j,counter,0) =
        ...
        (16. * r6);
    Y(j,counter,1) = -(std::sqrt(273 / Pi) * x * y * z *
    ...
    Y(j,counter,2) =
        ...
        (16. * r8);
    Y(j,counter,3) = (std::sqrt(273 / Pi) * y *
                   (5 * x2py3 - 85 * x2py2 * z2 + 100 * x2py21 * z4 - 8 * z6)) /
                  (16. * r8);
    counter++;

    Y(j,counter,0) = (std::sqrt(13 / Pi) * (-5 * x2py3 + 90 * x2py2 * z2 -
                                   120 * x2py21 * z4 + 16 * z6)) /
                 (32. * r6);
    Y(j,counter,1) = (-21 * std::sqrt(13 / Pi) * x * z2 *
                   (5 * x2py2 - 20 * x2py21 * z2 + 8 * z4)) /
                  (16. * r8);
    Y(j,counter,2) = (-21 * std::sqrt(13 / Pi) * y * z2 *
                   (5 * x2py2 - 20 * x2py21 * z2 + 8 * z4)) /
                  (16. * r8);
    Y(j,counter,3) = (21 * std::sqrt(13 / Pi) * x2py21 * z *
                   (5 * x2py2 - 20 * x2py21 * z2 + 8 * z4)) /
                  (16. * r8);
    counter++;
    ...
    Y(j,counter,0) =
        ...
        (16. * r6);
    Y(j,counter,1) = (std::sqrt(273 / Pi) * z *
                   (-5 * (x - y) * (x + y) * x2py2 +
                    5 * (17 * x2 - 3 * y2) * x2py21 * z2 -
                    4 * (25 * x2 + 3 * y2) * z4 + 8 * z6)) /
                  (16. * r8);
    Y(j,counter,2) = -(std::sqrt(273 / Pi) * x * y * z *
                    (5 * x2py2 - 50 * x2py21 * z2 + 44 * z4)) /
                  (8. * r8);
    Y(j,counter,3) = (std::sqrt(273 / Pi) * x *
                   (5 * x2py3 - 85 * x2py2 * z2 + 100 * x2py21 * z4 - 8 * z6)) /
                  (16. * r8);
    counter++;

    Y(j,counter,0) = (std::sqrt(1365 / two_pi) * (x - y) * (x + y) *
                  (x2py2 - 16 * x2py21 * z2 + 16 * z4)) /
                 (32. * r6);
    Y(j,counter,1) = (std::sqrt(1365 / two_pi) * x *
                   (2 * y2 * x2py2 + (19 * x2 - 49 * y2) * x2py21 * z2 +
                    64 * (-x + y) * (x + y) * z4 + 16 * z6)) /
                  (16. * r8);
    Y(j,counter,2) = -(std::sqrt(1365 / two_pi) * y *
                    (2 * x2 * x2py2 - (49 * x2 - 19 * y2) * x2py21 * z2 +
                     64 * (x - y) * (x + y) * z4 + 16 * z6)) /
                  (16. * r8);
    Y(j,counter,3) = -(std::sqrt(1365 / two_pi) * (x - y) * (x + y) * z *
                    (19 * x2py2 - 64 * x2py21 * z2 + 16 * z4)) /
                  (16. * r8);
    counter++;
    ...
    Y(j,counter,0) =
        ...
        (16. * r6);
    Y(j,counter,1) = (3 * std::sqrt(1365 / two_pi) * z *
    ...
    Y(j,counter,2) =
        ...
        (8. * r8);
    Y(j,counter,3) = (-3 * std::sqrt(1365 / two_pi) * (x3 - 3 * xy2) *
                   (x2py2 - 13 * x2py21 * z2 + 8 * z4)) /
                  (16. * r8);
    counter++;
    ...
    Y(j,counter,2) =
        (-3 * std::sqrt(91 / Pi) * y *
         (-8 * x6 + 8 * x2 * y4 + (85 * x4 - 150 * x2 * y2 + 13 * y4) * z2 +
          20 * (3 * x2 - y2) * z4)) /
        (16. * r8);
    Y(j,counter,3) = (3 * std::sqrt(91 / Pi) * (x4 - 6 * x2 * y2 + y4) * z *
                   (13 * x2py21 - 20 * z2)) /
                  (16. * r8);
    counter++;
    ...
    Y(j,counter,0) =
        ...
        (16. * r6);
    Y(j,counter,1) = (3 * std::sqrt(1001 / two_pi) * z *
    ...
    Y(j,counter,2) =
        ...
        (8. * r8);
    Y(j,counter,3) = (3 * std::sqrt(1001 / two_pi) * (x5 - 10 * x3 * y2 + 5 * x * y4) *
                   (x2 + y2 - 5 * z2)) /
                  (16. * r8);
    counter++;
    ...
    Y(j,counter,0) =
        ...
        (32. * r6);
    Y(j,counter,1) = (3 * std::sqrt(3003 / two_pi) * x *
                   (6 * y6 + 5 * y4 * z2 - 10 * x2 * y2 * (2 * y2 + z2) +
                    x4 * (6 * y2 + z2))) /
                  (16. * r8);
    Y(j,counter,2) = (-3 * std::sqrt(3003 / two_pi) * y *
  ...
  { // l_counter == 7
    Y(j,counter,0) = (-3 * std::sqrt(715 / Pi) * y *
                  (-7 * x6 + 35 * x4 * y2 - 21 * x2 * y4 + y6)) /
                 (64. * r7);
    Y(j,counter,1) = (21 * std::sqrt(715 / Pi) * x * y *
                   (-x6 + 7 * y6 + 6 * y4 * z2 + 3 * x4 * (7 * y2 + 2 * z2) -
                    5 * x2 * (7 * y4 + 4 * y2 * z2))) /
                  (64. * r9);
    Y(j,counter,2) = (21 * std::sqrt(715 / Pi) *
                   (x8 - 21 * x6 * y2 + 35 * x4 * y4 - 7 * x2 * y6 +
                    (x6 - 15 * x4 * y2 + 15 * x2 * y4 - y6) * z2)) /
                  (64. * r9);
    Y(j,counter,3) = (21 * std::sqrt(715 / Pi) * y *
                   (-7 * x6 + 35 * x4 * y2 - 21 * x2 * y4 + y6) * z) /
                  (64. * r9);
    counter++;

    Y(j,counter,0) = (3 * std::sqrt(5005 / two_pi) *
                  (3 * x5 * y - 10 * x3 * y3 + 3 * x * y5) * z) /
                 (16. * r7);
    Y(j,counter,1) = (3 * std::sqrt(5005 / two_pi) * y * z *
                   (-6 * x6 + 55 * x4 * y2 - 48 * x2 * y4 + 3 * y6 +
                    3 * (5 * x4 - 10 * x2 * y2 + y4) * z2)) /
                  (16. * r9);
    Y(j,counter,2) = (3 * std::sqrt(5005 / two_pi) * x * z *
    ...
    Y(j,counter,2) = (-3 * c11 *
                   (5 * x2 * x2py21 * (x4 - 10 * x2 * y2 + 5 * y4) +
                    ...
                    60 * (x4 - 6 * x2 * y2 + y4) * z4)) /
                  (64. * r9);
    Y(j,counter,3) = (3 * c11 * (5 * x4 * y - 10 * x2 * y3 + y5) * z *
                   (31 * x2py21 - 60 * z2)) /
                  (64. * r9);
    counter++;
    ...
    Y(j,counter,2) =
        ...
        (8. * r9);
    Y(j,counter,3) = (-3 * c11 * x * (x - y) * y * (x + y) *
                   (3 * x2py2 - 48 * x2py21 * z2 + 40 * z4)) /
                  (8. * r9);
    counter++;

    Y(j,counter,0) = (-3 * c9 * y * (-3 * x2 + y2) *
    ...
    Y(j,counter,2) = (3 * c9 *
                   (9 * x2 * (x2 - 3 * y2) * x2py2 -
                    ...
                    240 * (x - y) * (x + y) * z6)) /
                  (64. * r9);
    Y(j,counter,3) = (3 * c9 * y * (-3 * x2 + y2) * z *
    ...
    Y(j,counter,2) = (3 * c11 * y * z *
                   (3 * x2py21 * (17 * x4 - 22 * x2 * y2 + y4) -
                    ...
                    40 * (-3 * x2 + y2) * z4)) /
                  (32. * r9);
    Y(j,counter,3) = (-3 * c11 * (x4 - 6 * x2 * y2 + y4) *
                   (3 * x2py2 - 48 * x2py21 * z2 + 40 * z4)) /
                  (32. * r9);
    counter++;
    ...
    Y(j,counter,1) = (-3 * c11 *
                   (5 * y2 * x2py21 * (5 * x4 - 10 * x2 * y2 + y4) +
                    ...
                    60 * (x4 - 6 * x2 * y2 + y4) * z4)) /
                  (64. * r9);
    Y(j,counter,2) = (3 * c11 * x * y *
                   (5 * x2py21 * (5 * x4 - 10 * x2 * y2 + y4) -
                    2 * (153 * x4 - 430 * x2 * y2 + 105 * y4) * z2 -
                    240 * (x - y) * (x + y) * z4)) /
                  (64. * r9);
    Y(j,counter,3) = (3 * c11 * (x5 - 10 * x3 * y2 + 5 * x * y4) * z *
                   (31 * x2py21 - 60 * z2)) /
                  (64. * r9);
    counter++;
    ...
    Y(j,counter,0) = (3 * std::sqrt(5005 / two_pi) *
                  (x6 - 15 * x4 * y2 + 15 * x2 * y4 - y6) * z) /
                 (32. * r7);
    Y(j,counter,1) = (-3 * std::sqrt(5005 / two_pi) * x * z *
                   (x6 - 51 * x4 * y2 + 135 * x2 * y4 - 37 * y6 -
                    6 * (x4 - 10 * x2 * y2 + 5 * y4) * z2)) /
                  (32. * r9);
    Y(j,counter,2) = (3 * std::sqrt(5005 / two_pi) * y * z *
    ...
    Y(j,counter,0) = (3 * std::sqrt(715 / Pi) *
    ...
    Y(j,counter,1) =
        ...
        (64. * r9);
    Y(j,counter,2) = (-21 * std::sqrt(715 / Pi) * x * y *
                   (7 * x6 - 35 * x4 * y2 + 21 * x2 * y4 - y6 +
                    2 * (3 * x4 - 10 * x2 * y2 + 3 * y4) * z2)) /
                  (64. * r9);
    Y(j,counter,3) = (-21 * std::sqrt(715 / Pi) *
  ...
  { // l_counter == 8
    Y(j,counter,0) =
        ...
        (32. * r8);
    Y(j,counter,1) = (-3 * std::sqrt(12155 / Pi) * y *
                   (x8 + y6 * (y2 + z2) + 35 * x4 * y2 * (2 * y2 + z2) -
                    7 * x6 * (4 * y2 + z2) - 7 * x2 * (4 * y6 + 3 * y4 * z2))) /
                  (32. * r10);
    Y(j,counter,2) = (3 * std::sqrt(12155 / Pi) * x *
                   (x8 - 28 * x6 * y2 + 70 * x4 * y4 - 28 * x2 * y6 + y8 +
                    (x6 - 21 * x4 * y2 + 35 * x2 * y4 - 7 * y6) * z2)) /
                  (32. * r10);
    Y(j,counter,3) = (3 * std::sqrt(12155 / Pi) * x * y *
                   (-x6 + 7 * x4 * y2 - 7 * x2 * y4 + y6) * z) /
                  (4. * r10);
    counter++;

    Y(j,counter,0) = (-3 * std::sqrt(12155 / Pi) * y *
                  (-7 * x6 + 35 * x4 * y2 - 21 * x2 * y4 + y6) * z) /
                 (64. * r8);
    Y(j,counter,1) = (3 * std::sqrt(12155 / Pi) * x * y * z *
                   (-7 * x6 + 91 * x4 * y2 - 133 * x2 * y4 + 25 * y6 +
                    7 * (3 * x4 - 10 * x2 * y2 + 3 * y4) * z2)) /
                  (32. * r10);
    Y(j,counter,2) = (3 * std::sqrt(12155 / Pi) * z *
    ...
    Y(j,counter,0) = (-3 * std::sqrt(17017 / Pi) * (5 * x4 * y - 10 * x2 * y3 + y5) * z *
                  (x2 + y2 - 4 * z2)) /
                 (64. * r8);
    Y(j,counter,1) = (3 * std::sqrt(17017 / Pi) * x * y * z *
                   (5 * x6 - 25 * x4 * y2 - 17 * x2 * y4 + 13 * y6 +
                    (-55 * x4 + 170 * x2 * y2 - 47 * y4) * z2 +
                    40 * (x - y) * (x + y) * z4)) /
                  (32. * r10);
    Y(j,counter,2) = (3 * std::sqrt(17017 / Pi) * z *
                   (-5 * x8 + 50 * x6 * y2 + 20 * x4 * y4 - 34 * x2 * y6 + y8 +
                    (15 * x6 - 245 * x4 * y2 + 265 * x2 * y4 - 19 * y6) * z2 +
                    20 * (x4 - 6 * x2 * y2 + y4) * z4)) /
                  (64. * r10);
    Y(j,counter,3) = (-3 * std::sqrt(17017 / Pi) * (5 * x4 * y - 10 * x2 * y3 + y5) *
                   (x2py2 - 19 * x2py21 * z2 + 20 * z4)) /
                  (64. * r10);
    counter++;

    Y(j,counter,0) = (3 * std::sqrt(1309 / Pi) * x * (x - y) * y * (x + y) *
    ...
    Y(j,counter,2) =
        ...
        (32. * r10);
    Y(j,counter,3) = (-3 * std::sqrt(1309 / Pi) * x * (x - y) * y * (x + y) * z *
                   (7 * x2py2 - 38 * x2py21 * z2 + 20 * z4)) /
                  (4. * r10);
    counter++;

    Y(j,counter,0) = (std::sqrt(19635 / Pi) * (3 * x2 * y - y3) * z *
    ...
    Y(j,counter,1) =
        ...
        (32. * r10);
    Y(j,counter,2) = (3 * std::sqrt(19635 / Pi) * z *
                   (x2py2 * (3 * x4 - 12 * x2 * y2 + y4) -
                    x2py21 * (17 * x4 - 132 * x2 * y2 + 27 * y4) * z2 -
                    4 * (x4 + 42 * x2 * y2 - 15 * y4) * z4 +
                    16 * (x - y) * (x + y) * z6)) /
                  (64. * r10);
    Y(j,counter,3) = (-3 * std::sqrt(19635 / Pi) * y * (-3 * x2 + y2) *
                   (x2py3 - 27 * x2py2 * z2 + 60 * x2py21 * z4 - 16 * z6)) /
                  (64. * r10);
    counter++;

    Y(j,counter,0) = (-3 * std::sqrt(595 / two_pi) * x * y *
    ...
    Y(j,counter,0) =
        (-3 * std::sqrt(17 / Pi) * x * z *
         (35 * x2py3 - 280 * x2py2 * z2 + 336 * x2py21 * z4 - 64 * z6)) /
        (64. * r8);
    Y(j,counter,1) = (3 * std::sqrt(17 / Pi) * z *
                   (35 * (x - y) * (x + y) * x2py3 -
    ...
    Y(j,counter,2) =
        (3 * std::sqrt(17 / Pi) * x * y * z *
         (35 * x2py3 - 665 * x2py2 * z2 + 1568 * x2py21 * z4 - 592 * z6)) /
        (32. * r10);
    Y(j,counter,3) = (-3 * std::sqrt(17 / Pi) * x *
                   (35 * x2py4 - 1085 * x2py3 * z2 + 3080 * x2py2 * z4 -
                    1456 * x2py21 * z6 + 64 * z8)) /
                  (64. * r10);
    counter++;

    Y(j,counter,0) = (-3 * std::sqrt(595 / two_pi) * (x - y) * (x + y) *
                  (x2py3 - 30 * x2py2 * z2 + 80 * x2py21 * z4 - 32 * z6)) /
                 (64. * r8);
    Y(j,counter,1) = (-3 * std::sqrt(595 / two_pi) * x *
                   (y2 * x2py3 + (17 * x2 - 46 * y2) * x2py2 * z2 +
                    25 * (-5 * x4 + 2 * x2 * y2 + 7 * y4) * z4 +
                    16 * (8 * x2 - 5 * y2) * z6 - 16 * z8)) /
                  (16. * r10);
    Y(j,counter,2) = (3 * std::sqrt(595 / two_pi) * y *
    ...
    Y(j,counter,0) = (std::sqrt(19635 / Pi) * (x3 - 3 * xy2) * z *
                  (3 * x2py2 - 20 * x2py21 * z2 + 16 * z4)) /
                 (64. * r8);
    Y(j,counter,1) = (3 * std::sqrt(19635 / Pi) * z *
    ...
    Y(j,counter,2) =
        ...
        (32. * r10);
    Y(j,counter,3) = (3 * std::sqrt(19635 / Pi) * (x3 - 3 * xy2) *
                   (x2py3 - 27 * x2py2 * z2 + 60 * x2py21 * z4 - 16 * z6)) /
                  (64. * r10);
    counter++;

    Y(j,counter,0) = (3 * std::sqrt(1309 / Pi) * (x4 - 6 * x2 * y2 + y4) *
                  (x2py2 - 24 * x2py21 * z2 + 40 * z4)) /
                 (128. * r8);
    Y(j,counter,1) = (3 * std::sqrt(1309 / Pi) * x *
                   (2 * (x - y) * y2 * (x + y) * x2py2 +
                    x2py21 * (7 * x4 - 88 * x2 * y2 + 53 * y4) * z2 -
                    2 * (19 * x4 - 130 * x2 * y2 + 35 * y4) * z4 +
                    20 * (x2 - 3 * y2) * z6)) /
                  (16. * r10);
    Y(j,counter,2) = (3 * std::sqrt(1309 / Pi) * y *
                   (-2 * x2 * (x - y) * (x + y) * x2py2 +
                    x2py21 * (53 * x4 - 88 * x2 * y2 + 7 * y4) * z2 -
                    2 * (35 * x4 - 130 * x2 * y2 + 19 * y4) * z4 +
                    20 * (-3 * x2 + y2) * z6)) /
                  (16. * r10);
    Y(j,counter,3) = (-3 * std::sqrt(1309 / Pi) * (x4 - 6 * x2 * y2 + y4) * z *
                   (7 * x2py2 - 38 * x2py21 * z2 + 20 * z4)) /
                  (16. * r10);
    counter++;

    Y(j,counter,0) = (-3 * std::sqrt(17017 / Pi) * (x5 - 10 * x3 * y2 + 5 * x * y4) * z *
                  (x2 + y2 - 4 * z2)) /
                 (64. * r8);
    Y(j,counter,1) = (3 * std::sqrt(17017 / Pi) * z *
                   (x8 - 34 * x6 * y2 + 20 * x4 * y4 + 50 * x2 * y6 - 5 * y8 +
                    (-19 * x6 + 265 * x4 * y2 - 245 * x2 * y4 + 15 * y6) * z2 +
                    20 * (x4 - 6 * x2 * y2 + y4) * z4)) /
                  (64. * r10);
    Y(j,counter,2) = (-3 * std::sqrt(17017 / Pi) * x * y * z *
                   (-13 * x6 + x4 * (17 * y2 + 47 * z2) +
                    5 * x2 * (5 * y4 - 34 * y2 * z2 + 8 * z4) -
                    5 * (y6 - 11 * y4 * z2 + 8 * y2 * z4))) /
                  (32. * r10);
    Y(j,counter,3) = (-3 * std::sqrt(17017 / Pi) * (x5 - 10 * x3 * y2 + 5 * x * y4) *
                   (x2py2 - 19 * x2py21 * z2 + 20 * z4)) /
                  (64. * r10);
    counter++;
    ...
    Y(j,counter,0) =
        -(std::sqrt(7293 / two_pi) * (x6 - 15 * x4 * y2 + 15 * x2 * y4 - y6) *
          (x2 + y2 - 14 * z2)) /
        (64. * r8);
    Y(j,counter,1) = (-3 * std::sqrt(7293 / two_pi) * x *
    ...
    Y(j,counter,0) = (3 * std::sqrt(12155 / Pi) *
                  (std::pow(x, 7) - 21 * x5 * y2 + 35 * x3 * y4 - 7 * x * y6) * z) /
                 (64. * r8);
    Y(j,counter,1) = (-3 * std::sqrt(12155 / Pi) * z *
                   (x8 + 7 * y6 * (y2 + z2) - 7 * x6 * (10 * y2 + z2) +
                    35 * x4 * (8 * y4 + 3 * y2 * z2) -
                    7 * x2 * (22 * y6 + 15 * y4 * z2))) /
                  (64. * r10);
    Y(j,counter,2) = (-3 * std::sqrt(12155 / Pi) * x * y * z *
                   (25 * x6 - 133 * x4 * y2 + 91 * x2 * y4 - 7 * y6 +
                    7 * (3 * x4 - 10 * x2 * y2 + 3 * y4) * z2)) /
                  (32. * r10);
    Y(j,counter,3) = (3 * std::sqrt(12155 / Pi) *
                   (std::pow(x, 7) - 21 * x5 * y2 + 35 * x3 * y4 - 7 * x * y6) *
                   (x2 + y2 - 7 * z2)) /
                  (64. * r10);
    counter++;
    ...
    Y(j,counter,0) = (3 * std::sqrt(12155 / Pi) *
                  (x8 - 28 * x6 * y2 + 70 * x4 * y4 - 28 * x2 * y6 + y8)) /
                 (256. * r8);
    Y(j,counter,1) = (3 * std::sqrt(12155 / Pi) * x *
                   (8 * y2 * (x6 - 7 * x4 * y2 + 7 * x2 * y4 - y6) +
                    (x6 - 21 * x4 * y2 + 35 * x2 * y4 - 7 * y6) * z2)) /
                  (32. * r10);
    Y(j,counter,2) = (3 * std::sqrt(12155 / Pi) * y *
  ...
  { // l_counter == 9
    Y(j,counter,0) =
        ...
        (256. * r9);
    Y(j,counter,1) = (-9 * std::sqrt(230945 / two_pi) * x * y *
    ...
    Y(j,counter,2) =
        ...
        (256. * r11);
    Y(j,counter,3) = (-9 * std::sqrt(230945 / two_pi) *
    ...
    Y(j,counter,0) = (3 * std::sqrt(230945 / Pi) * x * y *
                  (x6 - 7 * x4 * y2 + 7 * x2 * y4 - y6) * z) /
                 (32. * r9);
    Y(j,counter,1) = (-3 * std::sqrt(230945 / Pi) * y * z *
                   (2 * x8 - 35 * x6 * y2 + 77 * x4 * y4 - 29 * x2 * y6 + y8 +
                    (-7 * x6 + 35 * x4 * y2 - 21 * x2 * y4 + y6) * z2)) /
                  (32. * r11);
    Y(j,counter,2) = (3 * std::sqrt(230945 / Pi) * x * z *
                   (x8 - 29 * x6 * y2 + 77 * x4 * y4 - 35 * x2 * y6 + 2 * y8 +
                    (x6 - 21 * x4 * y2 + 35 * x2 * y4 - 7 * y6) * z2)) /
                  (32. * r11);
    Y(j,counter,3) = (3 * std::sqrt(230945 / Pi) * x * y *
    ...
    Y(j,counter,2) =
        ...
        (256. * r11);
    Y(j,counter,3) = (-3 * std::sqrt(13585 / two_pi) * y *
                   (-7 * x6 + 35 * x4 * y2 - 21 * x2 * y4 + y6) * z *
                   (41 * x2py21 - 112 * z2)) /
                  (256. * r11);
    counter++;
    ...
    Y(j,counter,0) = (3 * std::sqrt(2717 / two_pi) * (5 * x4 * y - 10 * x2 * y3 + y5) *
                  (x2py2 - 28 * x2py21 * z2 + 56 * z4)) /
                 (128. * r9);
    Y(j,counter,1) = (-15 * std::sqrt(2717 / two_pi) * x * y *
    ...
    Y(j,counter,0) = (3 * std::sqrt(95095 / Pi) * x * (x - y) * y * (x + y) * z *
    ...
    Y(j,counter,2) =
        ...
        (32. * r11);
    Y(j,counter,3) = (3 * std::sqrt(95095 / Pi) * x * (x - y) * y * (x + y) *
                   (x2py3 - 32 * x2py2 * z2 + 88 * x2py21 * z4 - 32 * z6)) /
                  (32. * r11);
    counter++;

    Y(j,counter,0) = (std::sqrt(21945 / two_pi) * y * (-3 * x2 + y2) *
    ...
    Y(j,counter,1) =
        ...
        (128. * r11);
    Y(j,counter,2) = (-3 * std::sqrt(21945 / two_pi) *
                   (x2 * (x2 - 3 * y2) * x2py3 -
    ...
    Y(j,counter,0) = (-3 * std::sqrt(1045 / two_pi) * x * y * z *
    ...
    Y(j,counter,2) =
        ...
        (64. * r11);
    Y(j,counter,3) = (-3 * std::sqrt(1045 / two_pi) * (x - y) * (x + y) *
                   (7 * x2py4 - 266 * x2py3 * z2 + 980 * x2py2 * z4 -
                    672 * x2py21 * z6 + 64 * z8)) /
                  (64. * r11);
    counter++;

    Y(j,counter,0) = -(std::sqrt(21945 / two_pi) * (x3 - 3 * xy2) *
                   (x2py3 - 36 * x2py2 * z2 + 120 * x2py21 * z4 - 64 * z6)) /
                 (128. * r9);
    Y(j,counter,1) = (-3 * std::sqrt(21945 / two_pi) *
                   (-(y2 * (-3 * x2 + y2) * x2py3) +
    ...
    Y(j,counter,0) = (3 * std::sqrt(95095 / Pi) * (x4 - 6 * x2 * y2 + y4) * z *
                  (x2py2 - 8 * x2py21 * z2 + 8 * z4)) /
                 (128. * r9);
    Y(j,counter,1) =
        (-3 * std::sqrt(95095 / Pi) * x * z *
    ...
    Y(j,counter,2) =
        ...
        (128. * r11);
    Y(j,counter,3) = (3 * std::sqrt(95095 / Pi) * (x4 - 6 * x2 * y2 + y4) *
                   (x2py3 - 32 * x2py2 * z2 + 88 * x2py21 * z4 - 32 * z6)) /
                  (128. * r11);
    counter++;

    Y(j,counter,0) = (3 * std::sqrt(2717 / two_pi) * (x5 - 10 * x3 * y2 + 5 * x * y4) *
                  (x2py2 - 28 * x2py21 * z2 + 56 * z4)) /
                 (128. * r9);
    Y(j,counter,1) =
        (15 * std::sqrt(2717 / two_pi) *
         (y2 * x2py2 * (5 * x4 - 10 * x2 * y2 + y4) +
          ...
          56 * (x4 - 6 * x2 * y2 + y4) * z6)) /
        (128. * r11);
    Y(j,counter,2) = (-15 * std::sqrt(2717 / two_pi) * x * y *
    ...
    Y(j,counter,0) = (-3 * std::sqrt(13585 / two_pi) *
                  (std::pow(x, 7) - 21 * x5 * y2 + 35 * x3 * y4 - 7 * x * y6) *
                  (x2 + y2 - 16 * z2)) /
                 (256. * r9);
    Y(j,counter,1) =
    ...
    Y(j,counter,2) =
        (3 * std::sqrt(13585 / two_pi) * x * y *
         (7 * x2py21 * (7 * x6 - 35 * x4 * y2 + 21 * x2 * y4 - y6) -
          ...
          224 * (3 * x4 - 10 * x2 * y2 + 3 * y4) * z4)) /
        (256. * r11);
    Y(j,counter,3) = (3 * std::sqrt(13585 / two_pi) *
                   (std::pow(x, 7) - 21 * x5 * y2 + 35 * x3 * y4 - 7 * x * y6) * z *
                   (41 * x2py21 - 112 * z2)) /
                  (256. * r11);
    counter++;

    Y(j,counter,0) = (3 * std::sqrt(230945 / Pi) *
                  (x8 - 28 * x6 * y2 + 70 * x4 * y4 - 28 * x2 * y6 + y8) * z) /
                 (256. * r9);
    Y(j,counter,1) =
    ...
    Y(j,counter,2) =
        ...
        (256. * r11);
    Y(j,counter,3) = (3 * std::sqrt(230945 / Pi) *
                   (x8 - 28 * x6 * y2 + 70 * x4 * y4 - 28 * x2 * y6 + y8) *
                   (x2 + y2 - 8 * z2)) /
                  (256. * r11);
    counter++;
    ...
    Y(j,counter,1) =
        ...
        (256. * r11);
    Y(j,counter,2) = (-9 * std::sqrt(230945 / two_pi) * x * y *
  ...
  { // l_counter == 10
    Y(j,counter,0) = (std::sqrt(969969 / two_pi) * x * y * (5 * x4 - 10 * x2 * y2 + y4) *
                  (x4 - 10 * x2 * y2 + 5 * y4)) /
                 (256. * r10);
    Y(j,counter,1) =
    ...
    Y(j,counter,0) = (std::sqrt(4849845 / two_pi) *
                  (9 * x8 * y - 84 * x6 * y3 + 126 * x4 * y5 -
                   36 * x2 * std::pow(y, 7) + std::pow(y, 9)) *
                  z) /
                 (256. * r10);
    ...
    Y(j,counter,2) =
        ...
        (256. * r12);
    Y(j,counter,3) = (std::sqrt(4849845 / two_pi) *
                   (9 * x8 * y - 84 * x6 * y3 + 126 * x4 * y5 -
                    36 * x2 * std::pow(y, 7) + std::pow(y, 9)) *
                   (x2 + y2 - 9 * z2)) /
                  (256. * r12);
    ...
    Y(j,counter,1) =
        ...
        (64. * r12);
    Y(j,counter,2) = -(std::sqrt(255255 / Pi) * x *
    ...
    Y(j,counter,0) = (3 * std::sqrt(85085 / two_pi) * y *
                  (-7 * x6 + 35 * x4 * y2 - 21 * x2 * y4 + y6) * z *
                  (3 * x2py21 - 16 * z2)) /
                 (256. * r10);
    Y(j,counter,1) =
    ...
    Y(j,counter,2) =
        (3 * std::sqrt(85085 / two_pi) * z *
         (-3 * x2py21 *
          ...
          112 * (x6 - 15 * x4 * y2 + 15 * x2 * y4 - y6) * z4)) /
        (256. * r12);
    Y(j,counter,3) = (3 * std::sqrt(85085 / two_pi) * y *
                   (-7 * x6 + 35 * x4 * y2 - 21 * x2 * y4 + y6) *
    ...
    Y(j,counter,0) = (3 * std::sqrt(1001 / two_pi) * (5 * x4 * y - 10 * x2 * y3 + y5) *
                  z * (15 * x2py2 - 140 * x2py21 * z2 + 168 * z4)) /
                 (128. * r10);
    Y(j,counter,1) = (-15 * std::sqrt(1001 / two_pi) * x * y * z *
                   (3 * x2py2 * (5 * x4 - 30 * x2 * y2 + 13 * y4) -
                    4 * x2py21 * (85 * x4 - 295 * x2 * y2 + 92 * y4) * z2 +
                    28 * (33 * x4 - 70 * x2 * y2 + 9 * y4) * z4 -
                    336 * (x - y) * (x + y) * z6)) /
                  (64. * r12);
    Y(j,counter,2) = (15 * std::sqrt(1001 / two_pi) * z *
    ...
    Y(j,counter,0) = (-3 * std::sqrt(5005 / Pi) * x * (x - y) * y * (x + y) *
                  (x2py3 - 42 * x2py2 * z2 + 168 * x2py21 * z4 - 112 * z6)) /
                 (64. * r10);
    Y(j,counter,1) = (3 * std::sqrt(5005 / Pi) * y *
                   (x2py3 * (x4 - 6 * x2 * y2 + y4) -
    ...
    Y(j,counter,0) = (3 * std::sqrt(5005 / two_pi) * y * (-3 * x2 + y2) * z *
    ...
    Y(j,counter,1) =
        ...
        (64. * r12);
    Y(j,counter,2) = (3 * std::sqrt(5005 / two_pi) * z *
    ...
    Y(j,counter,0) = (std::sqrt(21 / Pi) * (-63 * std::pow(x2 + y2, 5) + 3150 * x2py4 * z2 -
                                   16800 * x2py3 * z4 + 20160 * x2py2 * z6 -
                                   5760 * x2py21 * z8 + 256 * std::pow(z, 10))) /
                 (512. * r10);
    Y(j,counter,1) = (-55 * std::sqrt(21 / Pi) * x * z2 *
                   (63 * x2py4 - 840 * x2py3 * z2 + 2016 * x2py2 * z4 -
                    1152 * x2py21 * z6 + 128 * z8)) /
                  (256. * r12);
    Y(j,counter,2) = (-55 * std::sqrt(21 / Pi) * y * z2 *
                   (63 * x2py4 - 840 * x2py3 * z2 + 2016 * x2py2 * z4 -
                    1152 * x2py21 * z6 + 128 * z8)) /
                  (256. * r12);
    Y(j,counter,3) = (55 * std::sqrt(21 / Pi) * x2py21 * z *
                   (63 * x2py4 - 840 * x2py3 * z2 + 2016 * x2py2 * z4 -
                    1152 * x2py21 * z6 + 128 * z8)) /
                  (256. * r12);
    counter++;

    Y(j,counter,0) = (std::sqrt(1155 / Pi) * x * z *
                  (63 * x2py4 - 840 * x2py3 * z2 + 2016 * x2py2 * z4 -
                   1152 * x2py21 * z6 + 128 * z8)) /
                 (256. * r10);
    Y(j,counter,1) = (std::sqrt(1155 / Pi) * z *
                   (-63 * (x - y) * (x + y) * x2py4 +
                  ...
                  (256. * r12);
    Y(j,counter,2) = -(std::sqrt(1155 / Pi) * x * y * z *
                    (63 * x2py4 - 1932 * x2py3 * z2 + 8568 * x2py2 * z4 -
                     8640 * x2py21 * z6 + 1792 * z8)) /
                  (128. * r12);
    Y(j,counter,3) =
    ...
    Y(j,counter,2) =
        ...
        (64. * r12);
    Y(j,counter,3) = (-3 * std::sqrt(5005 / two_pi) * (x3 - 3 * xy2) *
                   (7 * x2py4 - 315 * x2py3 * z2 + 1428 * x2py2 * z4 -
                    1288 * x2py21 * z6 + 192 * z8)) /
                  (128. * r12);
    counter++;

    Y(j,counter,0) = (-3 * std::sqrt(5005 / Pi) * (x4 - 6 * x2 * y2 + y4) *
                  (x2py3 - 42 * x2py2 * z2 + 168 * x2py21 * z4 - 112 * z6)) /
                 (256. * r10);
    Y(j,counter,1) = (-3 * std::sqrt(5005 / Pi) * x *
                   (-8 * y2 * (-x + y) * (x + y) * x2py3 +
                    ...
                    224 * (x2 - 3 * y2) * z8)) /
                  (128. * r12);
    Y(j,counter,2) = (-3 * std::sqrt(5005 / Pi) * y *
                   (-8 * x2 * (x - y) * (x + y) * x2py3 +
    ...
    Y(j,counter,0) = (3 * std::sqrt(1001 / two_pi) * (x5 - 10 * x3 * y2 + 5 * x * y4) *
                  z * (15 * x2py2 - 140 * x2py21 * z2 + 168 * z4)) /
                 (128. * r10);
    Y(j,counter,1) =
        (15 * std::sqrt(1001 / two_pi) * z *
         (-3 * x2py2 * (x6 - 35 * x4 * y2 + 55 * x2 * y4 - 5 * y6) +
          ...
          168 * (x4 - 6 * x2 * y2 + y4) * z6)) /
        (128. * r12);
    Y(j,counter,2) = (-15 * std::sqrt(1001 / two_pi) * x * y * z *
    ...
    Y(j,counter,0) = (-3 * std::sqrt(85085 / two_pi) *
                  (std::pow(x, 7) - 21 * x5 * y2 + 35 * x3 * y4 - 7 * x * y6) * z *
                  (3 * x2py21 - 16 * z2)) /
                 (256. * r10);
    Y(j,counter,1) =
    ...
    Y(j,counter,2) =
        (3 * std::sqrt(85085 / two_pi) * x * y * z *
         (3 * x2py21 * (25 * x6 - 133 * x4 * y2 + 91 * x2 * y4 - 7 * y6) -
          ...
          112 * (3 * x4 - 10 * x2 * y2 + 3 * y4) * z4)) /
        (128. * r12);
    Y(j,counter,3) = (-3 * std::sqrt(85085 / two_pi) *
                   (std::pow(x, 7) - 21 * x5 * y2 + 35 * x3 * y4 - 7 * x * y6) *
                   (3 * x2py2 - 75 * x2py21 * z2 + 112 * z4)) /
                  (256. * r12);
    counter++;

    Y(j,counter,0) = -(std::sqrt(255255 / Pi) *
                   (x8 - 28 * x6 * y2 + 70 * x4 * y4 - 28 * x2 * y6 + y8) *
                   (x2 + y2 - 18 * z2)) /
                 (512. * r10);
    Y(j,counter,1) = (std::sqrt(255255 / Pi) * x *
                  ...
                  (256. * r12);
    Y(j,counter,2) = (std::sqrt(255255 / Pi) * y *
                  ...
                  (256. * r12);
    Y(j,counter,3) = (std::sqrt(255255 / Pi) *
                   (x8 - 28 * x6 * y2 + 70 * x4 * y4 - 28 * x2 * y6 + y8) * z *
                   (23 * x2py21 - 72 * z2)) /
                  (256. * r12);
    counter++;
    ...
    Y(j,counter,1) =
        (std::sqrt(4849845 / two_pi) * z *
         (-std::pow(x, 10) + 117 * x8 * y2 - 882 * x6 * y4 + 1218 * x4 * y6 -
          ...
          9 * (x8 - 28 * x6 * y2 + 70 * x4 * y4 - 28 * x2 * y6 + y8) * z2)) /
        (256. * r12);
    Y(j,counter,2) = (std::sqrt(4849845 / two_pi) * x * y * z *
    ...
    Y(j,counter,2) =
        ...
        (256. * r12);
    Y(j,counter,3) = (-5 * std::sqrt(969969 / two_pi) *
                   (std::pow(x, 10) - 45 * x8 * y2 + 210 * x6 * y4 - 210 * x4 * y6 +
                    45 * x2 * y8 - std::pow(y, 10)) *
                   z) /
                  (256. * r12);
