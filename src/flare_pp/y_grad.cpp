...
void get_Y(vector<double> &Y, vector<double> &Yx, vector<double> &Yy,
  ...
  { // l_counter == 4
    ...
    Yy[counter] =
        ...
        (4. * r6);
    Yz[counter] =
        (-3 * c8 * y * (3 * x2py2 - 21 * (x2 + y2) * z2 + 4 * z4)) / (4. * r6);
    counter++;

    Y[counter] =
        (9 * x2py2 - 72 * (x2 + y2) * z2 + 24 * z4) / (16. * sqrt(Pi) * r4);
    Yx[counter] =
        (15 * x * z2 * (3 * (x2 + y2) - 4 * z2)) / (4. * sqrt(Pi) * r6);
    Yy[counter] =
        (15 * y * z2 * (3 * (x2 + y2) - 4 * z2)) / (4. * sqrt(Pi) * r6);
    Yz[counter] =
        (15 * (x2 + y2) * z * (-3 * (x2 + y2) + 4 * z2)) / (4. * sqrt(Pi) * r6);
    counter++;
    ...
    Yz[counter] =
        (-3 * c8 * x * (3 * x2py2 - 21 * (x2 + y2) * z2 + 4 * z4)) / (4. * r6);
    counter++;
    ...
    Yy[counter] =
        ...
        (2. * r6);
    Yz[counter] =
        (3 * c4 * (x - y) * (x + y) * z * (4 * (x2 + y2) - 3 * z2)) / (2. * r6);
    counter++;
  ...
  { // if l_counter == 5
    ...
    Yy[counter] = (-3 * c12 *
                  ...
                  (16. * r7);
    Yz[counter] =
        (-3 * c12 * y * (-3 * x2 + y2) * z * (7 * (x2 + y2) - 8 * z2)) /
        (16. * r7);
    counter++;
    ...
    Yy[counter] = (sqrt(1155 / Pi) * x * z *
                  ...
                  (4. * r7);
    Yz[counter] =
        -(sqrt(1155 / Pi) * x * y * (x2py2 - 10 * (x2 + y2) * z2 + 4 * z4)) /
        (4. * r7);
    counter++;

    Y[counter] = (sqrt(165 / Pi) * y * (x2py2 - 12 * (x2 + y2) * z2 + 8 * z4)) /
                 (16. * r5);
    Yx[counter] =
        -(sqrt(165 / Pi) * x * y * (x2py2 - 40 * (x2 + y2) * z2 + 64 * z4)) /
        (16. * r7);
    Yy[counter] =
        (sqrt(165 / Pi) * (x2 * x2py2 - (11 * x2 - 29 * y2) * (x2 + y2) * z2 -
                           4 * (x2 + 17 * y2) * z4 + 8 * z6)) /
        (16. * r7);
    Yz[counter] = -(sqrt(165 / Pi) * y * z *
                    (29 * x2py2 - 68 * (x2 + y2) * z2 + 8 * z4)) /
                  (16. * r7);
    counter++;

    Y[counter] =
        (sqrt(11 / Pi) * z * (15 * x2py2 - 40 * (x2 + y2) * z2 + 8 * z4)) /
        (16. * r5);
    Yx[counter] =
        (-15 * sqrt(11 / Pi) * x * z * (x2py2 - 12 * (x2 + y2) * z2 + 8 * z4)) /
        (16. * r7);
    Yy[counter] =
        (-15 * sqrt(11 / Pi) * y * z * (x2py2 - 12 * (x2 + y2) * z2 + 8 * z4)) /
        (16. * r7);
    Yz[counter] = (15 * sqrt(11 / Pi) * (x2 + y2) *
                   (x2py2 - 12 * (x2 + y2) * z2 + 8 * z4)) /
                  (16. * r7);
    counter++;

    Y[counter] = (sqrt(165 / Pi) * x * (x2py2 - 12 * (x2 + y2) * z2 + 8 * z4)) /
                 (16. * r5);
    Yx[counter] =
        (sqrt(165 / Pi) * (y2 * x2py2 + (29 * x2 - 11 * y2) * (x2 + y2) * z2 -
                           4 * (17 * x2 + y2) * z4 + 8 * z6)) /
        (16. * r7);
    Yy[counter] =
        -(sqrt(165 / Pi) * x * y * (x2py2 - 40 * (x2 + y2) * z2 + 64 * z4)) /
        (16. * r7);
    Yz[counter] = -(sqrt(165 / Pi) * x * z *
                    (29 * x2py2 - 68 * (x2 + y2) * z2 + 8 * z4)) /
                  (16. * r7);
    counter++;
    ...
    Yy[counter] =
        ...
        (16. * r7);
    Yz[counter] =
        (3 * c12 * (x3 - 3 * xy2) * z * (7 * (x2 + y2) - 8 * z2)) / (16. * r7);
    counter++;
  ...
  { // l_counter == 6
    ...
    Y[counter] = (sqrt(1365 / two_pi) * y * (-3 * x2 + y2) * z *
                  (3 * (x2 + y2) - 8 * z2)) /
                 (16. * r6);
    Yx[counter] =
    ...
    Yz[counter] = (3 * sqrt(1365 / two_pi) * y * (-3 * x2 + y2) *
                   (x2py2 - 13 * (x2 + y2) * z2 + 8 * z4)) /
                  (16. * r8);
    counter++;

    Y[counter] = (sqrt(1365 / two_pi) * x * y *
                  (x2py2 - 16 * (x2 + y2) * z2 + 16 * z4)) /
                 (16. * r6);
    Yx[counter] =
        (sqrt(1365 / two_pi) * y *
         (-((x - y) * (x + y) * x2py2) + (53 * x2 - 15 * y2) * (x2 + y2) * z2 -
          128 * x2 * z4 + 16 * z6)) /
        (16. * r8);
    Yy[counter] =
        (sqrt(1365 / two_pi) * x *
         ((x - y) * (x + y) * x2py2 - (15 * x2 - 53 * y2) * (x2 + y2) * z2 -
          128 * y2 * z4 + 16 * z6)) /
        (16. * r8);
    Yz[counter] = -(sqrt(1365 / two_pi) * x * y * z *
                    (19 * x2py2 - 64 * (x2 + y2) * z2 + 16 * z4)) /
                  (8. * r8);
    counter++;

    Y[counter] =
        (sqrt(273 / Pi) * y * z * (5 * x2py2 - 20 * (x2 + y2) * z2 + 8 * z4)) /
        (16. * r6);
    Yx[counter] = -(sqrt(273 / Pi) * x * y * z *
                    (5 * x2py2 - 50 * (x2 + y2) * z2 + 44 * z4)) /
                  (8. * r8);
    Yy[counter] = (sqrt(273 / Pi) * z *
                   (5 * (x - y) * (x + y) * x2py2 -
                    5 * (3 * x2 - 17 * y2) * (x2 + y2) * z2 -
                    4 * (3 * x2 + 25 * y2) * z4 + 8 * z6)) /
                  (16. * r8);
    Yz[counter] =
        (sqrt(273 / Pi) * y *
         (5 * x2py3 - 85 * x2py2 * z2 + 100 * (x2 + y2) * z4 - 8 * z6)) /
        (16. * r8);
    counter++;
    ...
    Yx[counter] = (-21 * sqrt(13 / Pi) * x * z2 *
                   (5 * x2py2 - 20 * (x2 + y2) * z2 + 8 * z4)) /
                  (16. * r8);
    Yy[counter] = (-21 * sqrt(13 / Pi) * y * z2 *
                   (5 * x2py2 - 20 * (x2 + y2) * z2 + 8 * z4)) /
                  (16. * r8);
    Yz[counter] = (21 * sqrt(13 / Pi) * (x2 + y2) * z *
                   (5 * x2py2 - 20 * (x2 + y2) * z2 + 8 * z4)) /
                  (16. * r8);
    counter++;

    Y[counter] =
        (sqrt(273 / Pi) * x * z * (5 * x2py2 - 20 * (x2 + y2) * z2 + 8 * z4)) /
        (16. * r6);
    Yx[counter] = (sqrt(273 / Pi) * z *
                   (-5 * (x - y) * (x + y) * x2py2 +
                    5 * (17 * x2 - 3 * y2) * (x2 + y2) * z2 -
    ...
    Yx[counter] = (sqrt(1365 / two_pi) * x *
                   (2 * y2 * x2py2 + (19 * x2 - 49 * y2) * (x2 + y2) * z2 +
                    64 * (-x + y) * (x + y) * z4 + 16 * z6)) /
                  (16. * r8);
    Yy[counter] = -(sqrt(1365 / two_pi) * y *
                    (2 * x2 * x2py2 - (49 * x2 - 19 * y2) * (x2 + y2) * z2 +
                     64 * (x - y) * (x + y) * z4 + 16 * z6)) /
                  (16. * r8);
    ...
    Y[counter] =
        -(sqrt(1365 / two_pi) * (x3 - 3 * xy2) * z * (3 * (x2 + y2) - 8 * z2)) /
        (16. * r6);
  ...
  { // l_counter == 7
    ...
    Yx[counter] = (3 * c11 * x * y *
                   (5 * (x2 + y2) * (x4 - 10 * x2 * y2 + 5 * y4) -
                    2 * (105 * x4 - 430 * x2 * y2 + 153 * y4) * z2 +
                    240 * (x - y) * (x + y) * z4)) /
                  (64. * r9);
    Yy[counter] = (-3 * c11 *
                   (5 * x2 * (x2 + y2) * (x4 - 10 * x2 * y2 + 5 * y4) +
    ...
    Y[counter] =
        (-3 * c11 * x * (x - y) * y * (x + y) * z * (3 * (x2 + y2) - 10 * z2)) /
        (8. * r7);
    Yx[counter] =
        (3 * c11 * y * z *
         (3 * (x2 + y2) * (2 * x4 - 7 * x2 * y2 + y4) +
          (-55 * x4 + 90 * x2 * y2 - 7 * y4) * z2 + 10 * (3 * x2 - y2) * z4)) /
        (8. * r9);
    Yy[counter] =
        (3 * c11 * x * z *
         (-3 * (x2 + y2) * (x4 - 7 * x2 * y2 + 2 * y4) +
          (7 * x4 - 90 * x2 * y2 + 55 * y4) * z2 + 10 * (x2 - 3 * y2) * z4)) /
        (8. * r9);
    Yz[counter] = (-3 * c11 * x * (x - y) * y * (x + y) *
                   (3 * x2py2 - 48 * (x2 + y2) * z2 + 40 * z4)) /
                  (8. * r9);
    counter++;

    Y[counter] = (-3 * c9 * y * (-3 * x2 + y2) *
                  (3 * x2py2 - 60 * (x2 + y2) * z2 + 80 * z4)) /
                 (64. * r7);
    Yx[counter] = (-3 * c9 * x * y *
                   (9 * (x2 - 3 * y2) * x2py2 -
                    6 * (99 * x2 - 109 * y2) * (x2 + y2) * z2 +
                    160 * (12 * x2 - 5 * y2) * z4 - 480 * z6)) /
                  (64. * r9);
    Yy[counter] = (3 * c9 *
                   (9 * x2 * (x2 - 3 * y2) * x2py2 -
                    3 * (x2 + y2) * (57 * x4 - 312 * x2 * y2 + 47 * y4) * z2 +
                    20 * (3 * x4 - 102 * x2 * y2 + 31 * y4) * z4 +
                    240 * (x - y) * (x + y) * z6)) /
                  (64. * r9);
    Yz[counter] = (3 * c9 * y * (-3 * x2 + y2) * z *
                   (141 * x2py2 - 620 * (x2 + y2) * z2 + 240 * z4)) /
                  (64. * r9);
    counter++;

    Y[counter] =
        (3 * c3 * x * y * z * (15 * x2py2 - 80 * (x2 + y2) * z2 + 48 * z4)) /
        (16. * r7);
    Yx[counter] = (3 * c3 * y * z *
                   (15 * (-2 * x6 - 3 * x4 * y2 + y6) +
                    5 * (79 * x2 - 13 * y2) * (x2 + y2) * z2 -
                    16 * (33 * x2 + 2 * y2) * z4 + 48 * z6)) /
                  (16. * r9);
    Yy[counter] = (3 * c3 * x * z *
                   (15 * (x2 - 2 * y2) * x2py2 -
                    5 * (13 * x2 - 79 * y2) * (x2 + y2) * z2 -
                    16 * (2 * x2 + 33 * y2) * z4 + 48 * z6)) /
                  (16. * r9);
    Yz[counter] =
        (3 * c3 * x * y *
         (15 * x2py3 - 330 * x2py2 * z2 + 560 * (x2 + y2) * z4 - 96 * z6)) /
        (16. * r9);
    counter++;

    Y[counter] =
        -(c5 * y *
          (5 * x2py3 - 120 * x2py2 * z2 + 240 * (x2 + y2) * z4 - 64 * z6)) /
        (64. * r7);
    Yx[counter] =
        (c5 * x * y *
         (5 * x2py3 - 390 * x2py2 * z2 + 1680 * (x2 + y2) * z4 - 928 * z6)) /
        (64. * r9);
    Yy[counter] =
        (c5 * (-5 * x2 * x2py3 + 5 * (23 * x2 - 55 * y2) * x2py2 * z2 -
               120 * (x2 - 13 * y2) * (x2 + y2) * z4 -
               16 * (11 * x2 + 69 * y2) * z6 + 64 * z8)) /
        (64. * r9);
    Yz[counter] =
        (c5 * y * z *
         (275 * x2py3 - 1560 * x2py2 * z2 + 1104 * (x2 + y2) * z4 - 64 * z6)) /
        (64. * r9);
    counter++;

    Y[counter] =
        (c2 * z *
         (-35 * x2py3 + 210 * x2py2 * z2 - 168 * (x2 + y2) * z4 + 16 * z6)) /
        (32. * r7);
    Yx[counter] =
        (7 * c2 * x * z *
         (5 * x2py3 - 120 * x2py2 * z2 + 240 * (x2 + y2) * z4 - 64 * z6)) /
    ...
    Y[counter] = (3 * c3 * (x - y) * (x + y) * z *
                  (15 * x2py2 - 80 * (x2 + y2) * z2 + 48 * z4)) /
                 (32. * r7);
    Yx[counter] = (-3 * c3 * x * z *
                   (15 * (x2 - 5 * y2) * x2py2 -
                    10 * (33 * x2 - 59 * y2) * (x2 + y2) * z2 +
                    16 * (35 * x2 - 27 * y2) * z4 - 96 * z6)) /
                  (32. * r9);
    Yy[counter] = (-3 * c3 * y * z *
                   (15 * (5 * x2 - y2) * x2py2 -
                    10 * (59 * x2 - 33 * y2) * (x2 + y2) * z2 +
    ...
    Y[counter] = (3 * c9 * (x3 - 3 * xy2) *
                  (3 * x2py2 - 60 * (x2 + y2) * z2 + 80 * z4)) /
                 (64. * r7);
    Yx[counter] = (3 * c9 *
                   (-9 * y2 * (-3 * x2 + y2) * x2py2 +
                    3 * (x2 + y2) * (47 * x4 - 312 * x2 * y2 + 57 * y4) * z2 -
                    20 * (31 * x4 - 102 * x2 * y2 + 3 * y4) * z4 +
                    240 * (x - y) * (x + y) * z6)) /
                  (64. * r9);
    Yy[counter] = (-3 * c9 * x * y *
                   (9 * (3 * x2 - y2) * x2py2 -
                    6 * (109 * x2 - 99 * y2) * (x2 + y2) * z2 +
    ...
    Y[counter] =
        (-3 * c11 * (x4 - 6 * x2 * y2 + y4) * z * (3 * (x2 + y2) - 10 * z2)) /
        (32. * r7);
    Yx[counter] = (3 * c11 * x * z *
                   (3 * (x2 + y2) * (x4 - 22 * x2 * y2 + 17 * y4) -
                    16 * (3 * x4 - 25 * x2 * y2 + 10 * y4) * z2 +
                    40 * (x2 - 3 * y2) * z4)) /
                  (32. * r9);
    Yy[counter] = (3 * c11 * y * z *
                   (3 * (x2 + y2) * (17 * x4 - 22 * x2 * y2 + y4) -
  ...
  { // l_counter == 8
    ...
    Yz[counter] = (-3 * sqrt(17017 / Pi) * (5 * x4 * y - 10 * x2 * y3 + y5) *
                   (x2py2 - 19 * (x2 + y2) * z2 + 20 * z4)) /
                  (64. * r10);
    counter++;

    Y[counter] = (3 * sqrt(1309 / Pi) * x * (x - y) * y * (x + y) *
                  (x2py2 - 24 * (x2 + y2) * z2 + 40 * z4)) /
                 (32. * r8);
    Yx[counter] =
        (-3 * sqrt(1309 / Pi) * y *
         (x2py2 * (x4 - 6 * x2 * y2 + y4) -
          (x2 + y2) * (79 * x4 - 194 * x2 * y2 + 23 * y4) * z2 +
          16 * (20 * x4 - 25 * x2 * y2 + y4) * z4 + 40 * (-3 * x2 + y2) * z6)) /
        (32. * r10);
    Yy[counter] =
        (3 * sqrt(1309 / Pi) * x *
         (x2py2 * (x4 - 6 * x2 * y2 + y4) -
          (x2 + y2) * (23 * x4 - 194 * x2 * y2 + 79 * y4) * z2 +
          16 * (x4 - 25 * x2 * y2 + 20 * y4) * z4 + 40 * (x2 - 3 * y2) * z6)) /
        (32. * r10);
    Yz[counter] = (-3 * sqrt(1309 / Pi) * x * (x - y) * y * (x + y) * z *
                   (7 * x2py2 - 38 * (x2 + y2) * z2 + 20 * z4)) /
                  (4. * r10);
    counter++;

    Y[counter] = (sqrt(19635 / Pi) * (3 * x2 * y - y3) * z *
                  (3 * x2py2 - 20 * (x2 + y2) * z2 + 16 * z4)) /
                 (64. * r8);
    Yx[counter] =
        (-3 * sqrt(19635 / Pi) * x * y * z *
         ((3 * x2 - 5 * y2) * x2py2 - (49 * x2 - 39 * y2) * (x2 + y2) * z2 +
          8 * (11 * x2 - 3 * y2) * z4 - 16 * z6)) /
        (32. * r10);
    Yy[counter] = (3 * sqrt(19635 / Pi) * z *
                   (x2py2 * (3 * x4 - 12 * x2 * y2 + y4) -
                    (x2 + y2) * (17 * x4 - 132 * x2 * y2 + 27 * y4) * z2 -
                    4 * (x4 + 42 * x2 * y2 - 15 * y4) * z4 +
                    16 * (x - y) * (x + y) * z6)) /
                  (64. * r10);
    Yz[counter] = (-3 * sqrt(19635 / Pi) * y * (-3 * x2 + y2) *
                   (x2py3 - 27 * x2py2 * z2 + 60 * (x2 + y2) * z4 - 16 * z6)) /
                  (64. * r10);
    counter++;

    Y[counter] = (-3 * sqrt(595 / two_pi) * x * y *
                  (x2py3 - 30 * x2py2 * z2 + 80 * (x2 + y2) * z4 - 32 * z6)) /
                 (32. * r8);
    Yx[counter] =
        (-3 * sqrt(595 / two_pi) * y *
         (-((x - y) * (x + y) * x2py3) + (97 * x2 - 29 * y2) * x2py2 * z2 -
          50 * (11 * x2 - y2) * (x2 + y2) * z4 + 16 * (29 * x2 + 3 * y2) * z6 -
          32 * z8)) /
        (32. * r10);
    Yy[counter] =
        (-3 * sqrt(595 / two_pi) * x *
         ((x - y) * (x + y) * x2py3 - (29 * x2 - 97 * y2) * x2py2 * z2 +
          50 * (x2 - 11 * y2) * (x2 + y2) * z4 + 16 * (3 * x2 + 29 * y2) * z6 -
          32 * z8)) /
        (32. * r10);
    Yz[counter] =
        (3 * sqrt(595 / two_pi) * x * y * z *
         (17 * x2py3 - 125 * x2py2 * z2 + 128 * (x2 + y2) * z4 - 16 * z6)) /
        (8. * r10);
    counter++;

    Y[counter] =
        (-3 * sqrt(17 / Pi) * y * z *
         (35 * x2py3 - 280 * x2py2 * z2 + 336 * (x2 + y2) * z4 - 64 * z6)) /
        (64. * r8);
    Yx[counter] =
        (3 * sqrt(17 / Pi) * x * y * z *
         (35 * x2py3 - 665 * x2py2 * z2 + 1568 * (x2 + y2) * z4 - 592 * z6)) /
        (32. * r10);
    Yy[counter] = (-3 * sqrt(17 / Pi) * z *
                   (35 * (x - y) * (x + y) * x2py3 -
                    35 * (7 * x2 - 31 * y2) * x2py2 * z2 +
                    56 * (x2 - 55 * y2) * (x2 + y2) * z4 +
    ...
    Yx[counter] = (3 * sqrt(19635 / Pi) * z *
                   (-(x2py2 * (x4 - 12 * x2 * y2 + 3 * y4)) +
                    (x2 + y2) * (27 * x4 - 132 * x2 * y2 + 17 * y4) * z2 +
                    4 * (-15 * x4 + 42 * x2 * y2 + y4) * z4 +
                    16 * (x - y) * (x + y) * z6)) /
                  (64. * r10);
    Yy[counter] =
        (-3 * sqrt(19635 / Pi) * x * y * z *
         ((5 * x2 - 3 * y2) * x2py2 - (39 * x2 - 49 * y2) * (x2 + y2) * z2 +
    ...
    Yx[counter] = (3 * sqrt(1309 / Pi) * x *
                   (2 * (x - y) * y2 * (x + y) * x2py2 +
                    (x2 + y2) * (7 * x4 - 88 * x2 * y2 + 53 * y4) * z2 -
                    2 * (19 * x4 - 130 * x2 * y2 + 35 * y4) * z4 +
                    20 * (x2 - 3 * y2) * z6)) /
                  (16. * r10);
    Yy[counter] = (3 * sqrt(1309 / Pi) * y *
                   (-2 * x2 * (x - y) * (x + y) * x2py2 +
                    (x2 + y2) * (53 * x4 - 88 * x2 * y2 + 7 * y4) * z2 -
  ...
  { // l_counter == 9
    ...
    Yx[counter] =
        (3 * sqrt(13585 / two_pi) * x * y *
         (7 * (x2 + y2) * (x6 - 21 * x4 * y2 + 35 * x2 * y4 - 7 * y6) -
          8 * (49 * x6 - 455 * x4 * y2 + 567 * x2 * y4 - 97 * y6) * z2 +
          224 * (3 * x4 - 10 * x2 * y2 + 3 * y4) * z4)) /
        (256. * r11);
    Yy[counter] =
        (-3 * sqrt(13585 / two_pi) *
         (7 * x2 * (x2 + y2) * (x6 - 21 * x4 * y2 + 35 * x2 * y4 - 7 * y6) +
    ...
    Yy[counter] = (-45 * sqrt(19 / Pi) * y * z *
                   (7 * x2py4 - 280 * x2py3 * z2 + 1120 * x2py2 * z4 -
                    896 * (x2 + y2) * z6 + 128 * z8)) /
                  (256. * r11);
    Yz[counter] = (45 * sqrt(19 / Pi) * (x2 + y2) *
                   (7 * x2py4 - 280 * x2py3 * z2 + 1120 * x2py2 * z4 -
                    896 * (x2 + y2) * z6 + 128 * z8)) /
                  (256. * r11);
    counter++;
    ...
    Yx[counter] = (-3 * sqrt(21945 / two_pi) *
                   (-(y2 * (-3 * x2 + y2) * x2py3) +
                    ...
                    4 * (x2 + y2) * (61 * x4 - 246 * x2 * y2 + 21 * y4) * z4 +
    ...
    Yx[counter] =
        (-3 * sqrt(95095 / Pi) * x * z *
         (x2py2 * (x4 - 22 * x2 * y2 + 17 * y4) -
          16 * (x - 3 * y) * (x + 3 * y) * (2 * x2 - y2) * (x2 + y2) * z2 +
          88 * (x4 - 6 * x2 * y2 + y4) * z4 - 32 * (x2 - 3 * y2) * z6)) /
        (128. * r11);
    Yy[counter] =
        (-3 * sqrt(95095 / Pi) * y * z *
         (x2py2 * (17 * x4 - 22 * x2 * y2 + y4) -
          16 * (3 * x - y) * (3 * x + y) * (x2 - 2 * y2) * (x2 + y2) * z2 +
    ...
    Yx[counter] =
        (-3 * sqrt(13585 / two_pi) *
         (-7 * y2 * (x2 + y2) * (-7 * x6 + 35 * x4 * y2 - 21 * x2 * y4 + y6) +
    ...
    Yy[counter] =
        (3 * sqrt(13585 / two_pi) * x * y *
         (7 * (x2 + y2) * (7 * x6 - 35 * x4 * y2 + 21 * x2 * y4 - y6) -
  ...
  { // l_counter == 10
    ...
    Yx[counter] =
        (3 * sqrt(85085 / two_pi) * x * y * z *
         (3 * (x2 + y2) * (7 * x6 - 91 * x4 * y2 + 133 * x2 * y4 - 25 * y6) -
    ...
    Yz[counter] = (3 * sqrt(85085 / two_pi) * y *
                   (-7 * x6 + 35 * x4 * y2 - 21 * x2 * y4 + y6) *
                   (3 * x2py2 - 75 * (x2 + y2) * z2 + 112 * z4)) /
                  (256. * r12);
    counter++;

    Y[counter] =
        (3 * sqrt(5005 / two_pi) * (3 * x5 * y - 10 * x3 * y3 + 3 * x * y5) *
         (3 * x2py2 - 96 * (x2 + y2) * z2 + 224 * z4)) /
        (256. * r10);
    Yx[counter] =
        (3 * sqrt(5005 / two_pi) * y *
         (-9 * x2py2 * (x6 - 15 * x4 * y2 + 15 * x2 * y4 - y6) +
          3 * (x2 + y2) *
              (315 * x6 - 2135 * x4 * y2 + 1617 * x2 * y4 - 93 * y6) * z2 -
    ...
    Yz[counter] =
        (15 * sqrt(1001 / two_pi) * (5 * x4 * y - 10 * x2 * y3 + y5) *
         (3 * x2py3 - 111 * x2py2 * z2 + 364 * (x2 + y2) * z4 - 168 * z6)) /
        (128. * r12);
    counter++;

    Y[counter] = (-3 * sqrt(5005 / Pi) * x * (x - y) * y * (x + y) *
                  (x2py3 - 42 * x2py2 * z2 + 168 * (x2 + y2) * z4 - 112 * z6)) /
                 (64. * r10);
    Yx[counter] = (3 * sqrt(5005 / Pi) * y *
                   (x2py3 * (x4 - 6 * x2 * y2 + y4) -
                    x2py2 * (135 * x4 - 340 * x2 * y2 + 41 * y4) * z2 +
                    126 * (x2 + y2) * (9 * x4 - 14 * x2 * y2 + y4) * z4 +
    ...
    Yy[counter] = (-55 * sqrt(21 / Pi) * y * z2 *
                   (63 * x2py4 - 840 * x2py3 * z2 + 2016 * x2py2 * z4 -
                    1152 * (x2 + y2) * z6 + 128 * z8)) /
                  (256. * r12);
    Yz[counter] = (55 * sqrt(21 / Pi) * (x2 + y2) * z *
                   (63 * x2py4 - 840 * x2py3 * z2 + 2016 * x2py2 * z4 -
                    1152 * (x2 + y2) * z6 + 128 * z8)) /
                  (256. * r12);
    counter++;
    ...
    Yx[counter] =
        (15 * sqrt(1001 / two_pi) * z *
         (-3 * x2py2 * (x6 - 35 * x4 * y2 + 55 * x2 * y4 - 5 * y6) +
          (x2 + y2) * (111 * x6 - 1735 * x4 * y2 + 1805 * x2 * y4 - 125 * y6) *
              z2 -
    ...
    Yy[counter] = (-15 * sqrt(1001 / two_pi) * x * y * z *
                   (3 * x2py2 * (13 * x4 - 30 * x2 * y2 + 5 * y4) -
                    4 * (x2 + y2) * (92 * x4 - 295 * x2 * y2 + 85 * y4) * z2 +
    ...
    Yx[counter] =
        (3 * sqrt(5005 / two_pi) * x *
         (18 * y2 * x2py2 * (3 * x4 - 10 * x2 * y2 + 3 * y4) +
          3 * (x2 + y2) *
              (37 * x6 - 1113 * x4 * y2 + 2415 * x2 * y4 - 595 * y6) * z2 +
    ...
    Yy[counter] =
        (-3 * sqrt(5005 / two_pi) * y *
         (18 * x2 * x2py2 * (3 * x4 - 10 * x2 * y2 + 3 * y4) -
          3 * (x2 + y2) *
              (595 * x6 - 2415 * x4 * y2 + 1113 * x2 * y4 - 37 * y6) * z2 +
    ...
    Yy[counter] =
        (3 * sqrt(85085 / two_pi) * x * y * z *
         (3 * (x2 + y2) * (25 * x6 - 133 * x4 * y2 + 91 * x2 * y4 - 7 * y6) -
