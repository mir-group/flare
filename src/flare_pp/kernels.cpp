...
Eigen::VectorXd ThreeBodyKernel :: self_kernel_env(
    ...
    double ri1, ri2, ri3, rj1, rj2, rj3,
        r11, r12, r13, r21, r22, r23, r31, r32, r33,
        p1, p2, p3, p4,
        xval_i1, xval_i2, xrel_i1, xrel_i2,
        yval_i1, yval_i2, yrel_i1, yrel_i2,
        zval_i1, zval_i2, zrel_i1, zrel_i2,
        xval_j1, xval_j2, xrel_j1, xrel_j2,
        yval_j1, yval_j2, yrel_j1, yrel_j2,
        zval_j1, zval_j2, zrel_j1, zrel_j2,
        fi1, fi2, fi3, fj1, fj2, fj3,
        fdi1, fdi2, fdj1, fdj2, fi, fj,
        fdix1, fdix2, fdiy1, fdiy2, fdiz1, fdiz2,
    ...
    for (int m = 0; m < env_curr.three_body_indices.size(); m ++){
        ...
        for (int n = 0; n < env_curr.three_body_indices.size(); n ++){
            ...
            if (c1 == c2){
                if (ei1 == ej1 && ei2 == ej2){
                    env_env_update_1(kernel_vector, no_elements, atom,
                    vol_inv, r11, r22, r33, fi, fj,
                    fdix1, fdix2, fdjx1, fdjx2,
                    fdiy1, fdiy2, fdjy1, fdjy2,
                    fdiz1, fdiz2, fdjz1, fdjz2,
                    xrel_i1, xval_i1, xrel_i2, xval_i2,
                    yrel_i1, yval_i1, yrel_i2, yval_i2,
                    zrel_i1, zval_i1, zrel_i2, zval_i2,
                    xrel_j1, xval_j1, xrel_j2, xval_j2,
                    yrel_j1, yval_j1, yrel_j2, yval_j2,
                    zrel_j1, zval_j1, zrel_j2, zval_j2);
                }
                if (ei1 == ej2 && ei2 == ej1){
                    env_env_update_1(kernel_vector, no_elements, atom,
                    vol_inv, r12, r21, r33, fi, fj,
                    fdix1, fdix2, fdjx2, fdjx1,
                    fdiy1, fdiy2, fdjy2, fdjy1,
                    fdiz1, fdiz2, fdjz2, fdjz1,
                    xrel_i1, xval_i1, xrel_i2, xval_i2,
                    yrel_i1, yval_i1, yrel_i2, yval_i2,
                    zrel_i1, zval_i1, zrel_i2, zval_i2,
                    xrel_j2, xval_j2, xrel_j1, xval_j1,
                    yrel_j2, yval_j2, yrel_j1, yval_j1,
                    zrel_j2, zval_j2, zrel_j1, zval_j1);
                }
            }

            if (c1 == ej1){
                if (ei1 == ej2 && ei2 == c2){
                    env_env_update_2(kernel_vector, no_elements, atom,
                    vol_inv, r21, r13, r32, fi, fj,
                    fdix2, fdix1, fdjx2, fdjx1,
                    fdiy2, fdiy1, fdjy2, fdjy1,
                    fdiz2, fdiz1, fdjz2, fdjz1,
                    xrel_i2, xval_i2, xrel_i1, xval_i1,
                    yrel_i2, yval_i2, yrel_i1, yval_i1,
                    zrel_i2, zval_i2, zrel_i1, zval_i1,
                    xrel_j2, xval_j2, xrel_j1, xval_j1,
                    yrel_j2, yval_j2, yrel_j1, yval_j1,
                    zrel_j2, zval_j2, zrel_j1, zval_j1);
                }
            ...
            if (c1 == ej2){
                if (ei1 == ej1 && ei2 == c2){
                    env_env_update_2(kernel_vector, no_elements, atom,
                    vol_inv, r22, r13, r31, fi, fj,
                    fdix2, fdix1, fdjx1, fdjx2,
                    fdiy2, fdiy1, fdjy1, fdjy2,
                    fdiz2, fdiz1, fdjz1, fdjz2,
                    xrel_i2, xval_i2, xrel_i1, xval_i1,
                    yrel_i2, yval_i2, yrel_i1, yval_i1,
                    zrel_i2, zval_i2, zrel_i1, zval_i1,
                    xrel_j1, xval_j1, xrel_j2, xval_j2,
        ...
        for (int j = i; j < struc.noa; j ++){
            ...
            for (int m = 0; m < env1.three_body_indices.size(); m ++){
                ...
                for (int n = 0; n < env2.three_body_indices.size(); n ++){
                    ...
                    if (c1 == c2){
                        if (ei1 == ej1 && ei2 == ej2){
                            struc_struc_update_1(kernel_vector, no_elements,
                            i, j, mult_fac, vol_inv, r11, r22, r33, fi, fj,
                            fdix1, fdix2, fdjx1, fdjx2,
                            fdiy1, fdiy2, fdjy1, fdjy2,
                            fdiz1, fdiz2, fdjz1, fdjz2,
                            xrel_i1, xval_i1, xrel_i2, xval_i2,
                        ...
                        if (ei1 == ej2 && ei2 == ej1){
                            struc_struc_update_1(kernel_vector, no_elements,
                            i, j, mult_fac, vol_inv, r12, r21, r33, fi, fj,
                            fdix1, fdix2, fdjx2, fdjx1,
                            fdiy1, fdiy2, fdjy2, fdjy1,
                            fdiz1, fdiz2, fdjz2, fdjz1,
                            xrel_i1, xval_i1, xrel_i2, xval_i2,
                    ...
                    if (c1 == ej1){
                        if (ei1 == ej2 && ei2 == c2){
                            struc_struc_update_2(kernel_vector, no_elements,
                            i, j, mult_fac, vol_inv, r21, r13, r32, fi, fj,
                            fdix2, fdix1, fdjx2, fdjx1,
                            fdiy2, fdiy1, fdjy2, fdjy1,
                            fdiz2, fdiz1, fdjz2, fdjz1,
                            xrel_i2, xval_i2, xrel_i1, xval_i1,
                        ...
                        if (ei1 == c2 && ei2 == ej2){
                            struc_struc_update_2(kernel_vector, no_elements,
                            i, j, mult_fac, vol_inv, r11, r23, r32, fi, fj,
                            fdix1, fdix2, fdjx2, fdjx1,
                            fdiy1, fdiy2, fdjy2, fdjy1,
                            fdiz1, fdiz2, fdjz2, fdjz1,
                            xrel_i1, xval_i1, xrel_i2, xval_i2,
                    ...
                    if (c1 == ej2){
                        if (ei1 == ej1 && ei2 == c2){
                            struc_struc_update_2(kernel_vector, no_elements,
                            i, j, mult_fac, vol_inv, r22, r13, r31, fi, fj,
                            fdix2, fdix1, fdjx1, fdjx2,
                            fdiy2, fdiy1, fdjy1, fdjy2,
                            fdiz2, fdiz1, fdjz1, fdjz2,
                            xrel_i2, xval_i2, xrel_i1, xval_i1,
                        ...
                        if (ei1 == c2 && ei2 == ej1){
                            struc_struc_update_2(kernel_vector, no_elements,
                            i, j, mult_fac, vol_inv, r12, r23, r31, fi, fj,
                            fdix1, fdix2, fdjx1, fdjx2,
                            fdiy1, fdiy2, fdjy1, fdjy2,
                            fdiz1, fdiz2, fdjz1, fdjz2,
                            xrel_i1, xval_i1, xrel_i2, xval_i2,
...
Eigen::VectorXd ThreeBodyKernel :: env_struc_partial(
    ...
    for (int m = 0; m < env1.three_body_indices.size(); m ++){
        ...
        for (int n = 0; n < env2.cross_bond_dists.size(); n ++){
            ...
            if (c1 == c2){
                if (ei1 == ej1 && ei2 == ej2){
                    env_struc_update(kernel_vector, no_elements, atom,
                        vol_inv, r11, r22, r33, fi, fj,
                        fdjx1, fdjx2, fdjy1, fdjy2, fdjz1, fdjz2,
...
void ThreeBodyKernel :: env_struc_update(Eigen::VectorXd & kernel_vector,
...
void ThreeBodyKernel :: env_env_update_1(Eigen::VectorXd & kernel_vector,
    int no_elements, int i, double vol_inv,
    double r11, double r22, double r33, double fi, double fj,
    double fdix1, double fdix2, double fdjx1, double fdjx2,
    double fdiy1, double fdiy2, double fdjy1, double fdjy2,
    double fdiz1, double fdiz2, double fdjz1, double fdjz2,
    double xrel_i1, double xval_i1, double xrel_i2, double xval_i2,
    double yrel_i1, double yval_i1, double yrel_i2, double yval_i2,
    double zrel_i1, double zval_i1, double zrel_i2, double zval_i2,
    double xrel_j1, double xval_j1, double xrel_j2, double xval_j2,
    double yrel_j1, double yval_j1, double yrel_j2, double yval_j2,
    double zrel_j1, double zval_j1, double zrel_j2, double zval_j2){
    ...
    double A_xx, B1_xx, B2_xx, d2_xx, dk_dix_xx, dk_djx_xx,
        k0_xx, k1_xx, k2_xx, k3_xx;
    ...
    k3_xx = d2_xx * fi * fj;
    kernel_vector(no_elements - 6) +=
        sig2 * (k0_xx - k1_xx - k2_xx + k3_xx) / 4;
...
void ThreeBodyKernel :: env_env_update_2(Eigen::VectorXd & kernel_vector,
    int no_elements, int i, double vol_inv,
    double r12, double r23, double r31, double fi, double fj,
    double fdix1, double fdix2, double fdjx1, double fdjx2,
    double fdiy1, double fdiy2, double fdjy1, double fdjy2,
    double fdiz1, double fdiz2, double fdjz1, double fdjz2,
    double xrel_i1, double xval_i1, double xrel_i2, double xval_i2,
...
void ThreeBodyKernel :: struc_struc_update_1(Eigen::VectorXd & kernel_vector,
    int no_elements, int i, int j, double mult_factor, double vol_inv,
    double r11, double r22, double r33, double fi, double fj,
    double fdix1, double fdix2, double fdjx1, double fdjx2,
    double fdiy1, double fdiy2, double fdjy1, double fdjy2,
    double fdiz1, double fdiz2, double fdjz1, double fdjz2,
    ...
    // fx + exx, exy, exz stress component
    force_stress_vals =
        force_stress_helper_1(mult_factor, vol_inv_sq, k_SE, r11, r22, r33,
            fi, fj, fdix1, fdix2, fdjx1, fdjx2, xrel_i1,  xrel_i2,
            xrel_j1, xrel_j2, xval_i1, xval_i2, yval_i1, yval_i2,
            zval_i1, zval_i2, xval_j1, xval_j2, yval_j1, yval_j2,
            zval_j1, zval_j2);
    ...
    force_stress_vals =
        force_stress_helper_1(mult_factor, vol_inv_sq, k_SE, r11, r22, r33,
            fi, fj, fdiy1, fdiy2, fdjy1, fdjy2, yrel_i1,  yrel_i2,
            yrel_j1, yrel_j2, xval_i1, xval_i2, yval_i1, yval_i2,
            zval_i1, zval_i2, xval_j1, xval_j2, yval_j1, yval_j2,
            zval_j1, zval_j2);
    ...
    force_stress_vals =
        force_stress_helper_1(mult_factor, vol_inv_sq, k_SE, r11, r22, r33,
            fi, fj, fdiz1, fdiz2, fdjz1, fdjz2, zrel_i1,  zrel_i2,
            zrel_j1, zrel_j2, xval_i1, xval_i2, yval_i1, yval_i2,
            zval_i1, zval_i2, xval_j1, xval_j2, yval_j1, yval_j2,
            zval_j1, zval_j2);
...
std::vector<double> ThreeBodyKernel :: force_stress_helper_1(
    double mult_factor, double vol_inv_sq, double k_SE,
    double r11, double r22, double r33, double fi, double fj,
    double fdix1, double fdix2, double fdjx1, double fdjx2,
    double xrel_i1, double xrel_i2, double xrel_j1, double xrel_j2, 
    double xval_i1, double xval_i2, double yval_i1, double yval_i2,
    double zval_i1, double zval_i2, double xval_j1, double xval_j2,
    double yval_j1, double yval_j2, double zval_j1, double zval_j2){
...
void ThreeBodyKernel :: struc_struc_update_2(Eigen::VectorXd & kernel_vector,
    int no_elements, int i, int j, double mult_factor, double vol_inv,
    double r12, double r23, double r31, double fi, double fj,
    double fdix1, double fdix2, double fdjx1, double fdjx2,
    double fdiy1, double fdiy2, double fdjy1, double fdjy2,
    ...
    // fx + exx, exy, exz stress component
    force_stress_vals =
        force_stress_helper_2(mult_factor, vol_inv_sq, k_SE, r12, r23, r31,
            fi, fj, fdix1, fdix2, fdjx1, fdjx2, xrel_i1,  xrel_i2,
            xrel_j1, xrel_j2, xval_i1, xval_i2, yval_i1, yval_i2,
            zval_i1, zval_i2, xval_j1, xval_j2, yval_j1, yval_j2,
            zval_j1, zval_j2);
