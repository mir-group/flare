...
class ThreeBodyKernel : public Kernel{
    public:
        ...
        void env_struc_update(Eigen::VectorXd & kernel_vector,
        ...
        void env_env_update_1(Eigen::VectorXd & kernel_vector,
            int no_elements, int i, double vol_inv,
            double r11, double r22, double r33,
            double fi, double fj,
        ...
        void env_env_update_2(Eigen::VectorXd & kernel_vector,
            int no_elements, int i, double vol_inv,
            double r11, double r22, double r33,
            double fi, double fj,
            double fdix1, double fdix2, double fdjx1, double fdjx2,
        ...
        void struc_struc_update_1(Eigen::VectorXd & kernel_vector,
        ...
        void struc_struc_update_2(Eigen::VectorXd & kernel_vector,
            int no_elements, int i, int j, double mult_factor, double vol_inv,
            double r12, double r23, double r31,
            double fi, double fj,
            double fdix1, double fdix2, double fdjx1, double fdjx2,
            double fdiy1, double fdiy2, double fdjy1, double fdjy2,
            double fdiz1, double fdiz2, double fdjz1, double fdjz2,
