...
void AddParametersModule(py::module m) {
  py::class_<HypsMask>(m, "HypsMask")
      ...
      .def_readwrite("threebody_cutoff_list", &HypsMask::threebody_cutoff_list)
      .def_readwrite("manybody_cutoff_list", &HypsMask::manybody_cutoff_list)
      ...
      .def(py::pickle(
          [](const HypsMask &s) { // __getstate__
            ...
            return py::make_tuple(
                ...
                s.twobody_start, s.threebody_start, s.manybody_start, s.ncut3b,
                s.specie_mask, s.twobody_mask, s.threebody_mask,
                s.manybody_mask, s.cut3b_mask, s.map, s.twobody_cutoff_list,
                s.threebody_cutoff_list, s.manybody_cutoff_list,
                s.original_hyps, s.hyps, s.original_labels, s.kernels,
                s.hyp_labels, s.train_noise, s.energy_noise, s.kernel_name,
                s.cutoffs);
          },
          [](py::tuple t) { // __setstate__
            ...
            p.cutoffs = t[25].cast<std::unordered_map<std::string, double>>();
