...
public:
  ...
  int nspecie = 1, ntwobody = 1, nthreebody = 1, nmanybody = 0, twobody_start,
      threebody_start, manybody_start, ncut3b = 1;
  std::vector<int> specie_mask, twobody_mask, threebody_mask, manybody_mask,
      cut3b_mask, map;
