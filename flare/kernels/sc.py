...
def two_plus_three_body_grad(
    env1, env2, d1, d2, hyps, cutoffs, cutoff_func=cf.quadratic_cutoff
):
    ...
    kern3, sig3, ls3 = three_body_grad_jit(
        env1.bond_array_3,
        env2.bond_array_3,
        env1.cross_bond_inds,
        env2.cross_bond_inds,
...
def two_plus_three_en(env1, env2, hyps, cutoffs, cutoff_func=cf.quadratic_cutoff):
...
def two_plus_three_plus_many_body(
    env1: AtomicEnvironment,
    env2: AtomicEnvironment,
    d1: int,
    d2: int,
...
def two_plus_three_plus_many_body_grad(
    env1: AtomicEnvironment,
    env2: AtomicEnvironment,
    d1: int,
    d2: int,
...
def two_plus_three_plus_many_body_force_en(
    env1: AtomicEnvironment,
    env2: AtomicEnvironment,
    d1: int,
    hyps,
...
def two_plus_three_plus_many_body_en(
    env1: AtomicEnvironment,
    env2: AtomicEnvironment,
    hyps,
    cutoffs,
...
def two_body(env1, env2, d1, d2, hyps, cutoffs, cutoff_func=cf.quadratic_cutoff):
    ...
    return two_body_jit(
        env1.bond_array_2, env2.bond_array_2, d1, d2, sig, ls, r_cut, cutoff_func
    )


def two_body_grad(env1, env2, d1, d2, hyps, cutoffs, cutoff_func=cf.quadratic_cutoff):
    ...
    kernel, ls_derv, sig_derv = two_body_grad_jit(
        env1.bond_array_2, env2.bond_array_2, d1, d2, sig, ls, r_cut, cutoff_func
    )
...
def two_body_force_en(env1, env2, d1, hyps, cutoffs, cutoff_func=cf.quadratic_cutoff):
    ...
    return (
        two_body_force_en_jit(
            env1.bond_array_2, env2.bond_array_2, d1, sig, ls, r_cut, cutoff_func
        )
        / 2
    )


def two_body_en(env1, env2, hyps, cutoffs, cutoff_func=cf.quadratic_cutoff):
    ...
    return (
        two_body_en_jit(
            env1.bond_array_2, env2.bond_array_2, sig, ls, r_cut, cutoff_func
        )
        / 4
    )
...
def three_body(env1, env2, d1, d2, hyps, cutoffs, cutoff_func=cf.quadratic_cutoff):
...
def three_body_grad(env1, env2, d1, d2, hyps, cutoffs, cutoff_func=cf.quadratic_cutoff):
    ...
    kernel, sig_derv, ls_derv = three_body_grad_jit(
        env1.bond_array_3,
        env2.bond_array_3,
        env1.cross_bond_inds,
        env2.cross_bond_inds,
...
def three_body_en(env1, env2, hyps, cutoffs, cutoff_func=cf.quadratic_cutoff):
...
def many_body(env1, env2, d1, d2, hyps, cutoffs, cutoff_func=cf.quadratic_cutoff):
...
def many_body_grad(env1, env2, d1, d2, hyps, cutoffs, cutoff_func=cf.quadratic_cutoff):
    ...
    kernel, sig_derv, ls_derv = many_body_grad_jit(
        env1.q_array,
        env2.q_array,
        env1.q_neigh_array,
        env2.q_neigh_array,
...
def many_body_force_en(env1, env2, d1, hyps, cutoffs, cutoff_func=cf.quadratic_cutoff):
...
def many_body_en(env1, env2, hyps, cutoffs, cutoff_func=cf.quadratic_cutoff):
    """many-body single-element kernel between two local energies.
...
@njit
def two_body_jit(bond_array_1, bond_array_2, d1, d2, sig, ls, r_cut, cutoff_func):
...
@njit
def two_body_grad_jit(bond_array_1, bond_array_2, d1, d2, sig, ls, r_cut, cutoff_func):
    """2-body single-element kernel between two force components and its
    gradient with respect to the hyperparameters.
...
@njit
def two_body_force_en_jit(bond_array_1, bond_array_2, d1, sig, ls, r_cut, cutoff_func):
    """2-body single-element kernel between a force component and a local
...
def many_body_grad_jit(
    ...
    for i in range(q_neigh_array_1.shape[0]):
        ...
        for j in range(q_neigh_array_2.shape[0]):
            ...
            sig_derv += 2.0 / sig * kern_term
            ls_derv += qi_grad * qj_grad * mb_grad_helper_ls(q1, q2, qis, qjs, sig, ls)
            kern += kern_term
...
@njit
def many_body_force_en_jit(
    q_array_1, q_array_2, q_neigh_array_1, q_neigh_grads, d1, sig, ls
):
...
def triplet_kernel_grad(
    ...
    N1, O1, X1 = three_body_grad_helper_1(
        ci1,
        ci2,
        cj1,
        cj2,
    ...
    N2, O2, X2 = three_body_grad_helper_2(
        ci2,
        ci1,
        cj2,
        cj1,
    ...
    N3, O3, X3 = three_body_grad_helper_2(
        ci1,
        ci2,
        cj1,
        cj2,
    ...
    N4, O4, X4 = three_body_grad_helper_1(
        ci1,
        ci2,
        cj2,
        cj1,
    ...
    N5, O5, X5 = three_body_grad_helper_2(
        ci2,
        ci1,
        cj1,
        cj2,
    ...
    N6, O6, X6 = three_body_grad_helper_2(
        ci1,
        ci2,
        cj2,
        cj1,
...
@njit
def triplet_force_en_kernel(
    ci1, ci2, ri1, ri2, ri3, rj1, rj2, rj3, fi, fj, fdi, ls1, ls2, sig2
):
    r11 = ri1 - rj1
    r12 = ri1 - rj2
    r13 = ri1 - rj3
    ...
    I1 = three_body_en_helper(ci1, ci2, r11, r22, r33, fi, fj, fdi, ls1, ls2, sig2)
    I2 = three_body_en_helper(ci1, ci2, r13, r21, r32, fi, fj, fdi, ls1, ls2, sig2)
    I3 = three_body_en_helper(ci1, ci2, r12, r23, r31, fi, fj, fdi, ls1, ls2, sig2)
...
def str_to_kernel(string: str, include_grad: bool = False):
    ...
    if not include_grad:
        ...
        if "two" in string and "three" in string:
            ...
            raise ValueError("Gradient callable for {} not found".format(string))
