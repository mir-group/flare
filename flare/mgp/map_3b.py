...
def _GenGrid_inner(name, s, e, bonds1, bonds2, bonds12, env12, kernel_info):
    ...
    return k_v  # np.moveaxis(k_v, 0, -1)
...
def three_body_mc_force_en_sephyps(env1, r1, r2, r12, c2, etypes2,
    ...
    tbmcj = three_body_mc_force_en_sephyps_jit
...
# @njit
def three_body_mc_force_en_sephyps_jit(bond_array_1, c1, etypes1,
                                       cross_bond_inds_1, cross_bond_dists_1,
                                       triplets_1,
                                       c2, etypes2, rj1, rj2, rj3,
                                       d1, sig3, ls3, r_cut, cutoff_func,
