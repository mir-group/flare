    ...
    for n in range(N):
        ...
        for k in range(n_vals):
            vals[n,k] = Phi0_0*(Phi1_0*(Phi2_0*(coefs[i0+0,i1+0,i2+0,k]) + Phi2_1*(coefs[i0+0,i1+0,i2+1,k]) + Phi2_2*(coefs[i0+0,i1+0,i2+2,k]) + Phi2_3*(coefs[i0+0,i1+0,i2+3,k])) + \
                                Phi1_1*(Phi2_0*(coefs[i0+0,i1+1,i2+0,k]) + Phi2_1*(coefs[i0+0,i1+1,i2+1,k]) + Phi2_2*(coefs[i0+0,i1+1,i2+2,k]) + Phi2_3*(coefs[i0+0,i1+1,i2+3,k])) + \
                                Phi1_2*(Phi2_0*(coefs[i0+0,i1+2,i2+0,k]) + Phi2_1*(coefs[i0+0,i1+2,i2+1,k]) + Phi2_2*(coefs[i0+0,i1+2,i2+2,k]) + Phi2_3*(coefs[i0+0,i1+2,i2+3,k])) + \
                                Phi1_3*(Phi2_0*(coefs[i0+0,i1+3,i2+0,k]) + Phi2_1*(coefs[i0+0,i1+3,i2+1,k]) + Phi2_2*(coefs[i0+0,i1+3,i2+2,k]) + Phi2_3*(coefs[i0+0,i1+3,i2+3,k]))) + \
                        Phi0_1*(Phi1_0*(Phi2_0*(coefs[i0+1,i1+0,i2+0,k]) + Phi2_1*(coefs[i0+1,i1+0,i2+1,k]) + Phi2_2*(coefs[i0+1,i1+0,i2+2,k]) + Phi2_3*(coefs[i0+1,i1+0,i2+3,k])) + \
                                Phi1_1*(Phi2_0*(coefs[i0+1,i1+1,i2+0,k]) + Phi2_1*(coefs[i0+1,i1+1,i2+1,k]) + Phi2_2*(coefs[i0+1,i1+1,i2+2,k]) + Phi2_3*(coefs[i0+1,i1+1,i2+3,k])) + \
                                Phi1_2*(Phi2_0*(coefs[i0+1,i1+2,i2+0,k]) + Phi2_1*(coefs[i0+1,i1+2,i2+1,k]) + Phi2_2*(coefs[i0+1,i1+2,i2+2,k]) + Phi2_3*(coefs[i0+1,i1+2,i2+3,k])) + \
                                Phi1_3*(Phi2_0*(coefs[i0+1,i1+3,i2+0,k]) + Phi2_1*(coefs[i0+1,i1+3,i2+1,k]) + Phi2_2*(coefs[i0+1,i1+3,i2+2,k]) + Phi2_3*(coefs[i0+1,i1+3,i2+3,k]))) + \
                        Phi0_2*(Phi1_0*(Phi2_0*(coefs[i0+2,i1+0,i2+0,k]) + Phi2_1*(coefs[i0+2,i1+0,i2+1,k]) + Phi2_2*(coefs[i0+2,i1+0,i2+2,k]) + Phi2_3*(coefs[i0+2,i1+0,i2+3,k])) + \
                                Phi1_1*(Phi2_0*(coefs[i0+2,i1+1,i2+0,k]) + Phi2_1*(coefs[i0+2,i1+1,i2+1,k]) + Phi2_2*(coefs[i0+2,i1+1,i2+2,k]) + Phi2_3*(coefs[i0+2,i1+1,i2+3,k])) + \
                                Phi1_2*(Phi2_0*(coefs[i0+2,i1+2,i2+0,k]) + Phi2_1*(coefs[i0+2,i1+2,i2+1,k]) + Phi2_2*(coefs[i0+2,i1+2,i2+2,k]) + Phi2_3*(coefs[i0+2,i1+2,i2+3,k])) + \
                                Phi1_3*(Phi2_0*(coefs[i0+2,i1+3,i2+0,k]) + Phi2_1*(coefs[i0+2,i1+3,i2+1,k]) + Phi2_2*(coefs[i0+2,i1+3,i2+2,k]) + Phi2_3*(coefs[i0+2,i1+3,i2+3,k]))) + \
                        Phi0_3*(Phi1_0*(Phi2_0*(coefs[i0+3,i1+0,i2+0,k]) + Phi2_1*(coefs[i0+3,i1+0,i2+1,k]) + Phi2_2*(coefs[i0+3,i1+0,i2+2,k]) + Phi2_3*(coefs[i0+3,i1+0,i2+3,k])) + \
                                Phi1_1*(Phi2_0*(coefs[i0+3,i1+1,i2+0,k]) + Phi2_1*(coefs[i0+3,i1+1,i2+1,k]) + Phi2_2*(coefs[i0+3,i1+1,i2+2,k]) + Phi2_3*(coefs[i0+3,i1+1,i2+3,k])) + \
                                Phi1_2*(Phi2_0*(coefs[i0+3,i1+2,i2+0,k]) + Phi2_1*(coefs[i0+3,i1+2,i2+1,k]) + Phi2_2*(coefs[i0+3,i1+2,i2+2,k]) + Phi2_3*(coefs[i0+3,i1+2,i2+3,k])) + \
                                Phi1_3*(Phi2_0*(coefs[i0+3,i1+3,i2+0,k]) + Phi2_1*(coefs[i0+3,i1+3,i2+1,k]) + Phi2_2*(coefs[i0+3,i1+3,i2+2,k]) + Phi2_3*(coefs[i0+3,i1+3,i2+3,k])))

            dvals[n,0,k] = dPhi0_0*(Phi1_0*(Phi2_0*(coefs[i0+0,i1+0,i2+0,k]) + Phi2_1*(coefs[i0+0,i1+0,i2+1,k]) + Phi2_2*(coefs[i0+0,i1+0,i2+2,k]) + Phi2_3*(coefs[i0+0,i1+0,i2+3,k])) + \
                                    Phi1_1*(Phi2_0*(coefs[i0+0,i1+1,i2+0,k]) + Phi2_1*(coefs[i0+0,i1+1,i2+1,k]) + Phi2_2*(coefs[i0+0,i1+1,i2+2,k]) + Phi2_3*(coefs[i0+0,i1+1,i2+3,k])) + \
                                    Phi1_2*(Phi2_0*(coefs[i0+0,i1+2,i2+0,k]) + Phi2_1*(coefs[i0+0,i1+2,i2+1,k]) + Phi2_2*(coefs[i0+0,i1+2,i2+2,k]) + Phi2_3*(coefs[i0+0,i1+2,i2+3,k])) + \
                                    Phi1_3*(Phi2_0*(coefs[i0+0,i1+3,i2+0,k]) + Phi2_1*(coefs[i0+0,i1+3,i2+1,k]) + Phi2_2*(coefs[i0+0,i1+3,i2+2,k]) + Phi2_3*(coefs[i0+0,i1+3,i2+3,k]))) + \
                           dPhi0_1*(Phi1_0*(Phi2_0*(coefs[i0+1,i1+0,i2+0,k]) + Phi2_1*(coefs[i0+1,i1+0,i2+1,k]) + Phi2_2*(coefs[i0+1,i1+0,i2+2,k]) + Phi2_3*(coefs[i0+1,i1+0,i2+3,k])) + \
                                    Phi1_1*(Phi2_0*(coefs[i0+1,i1+1,i2+0,k]) + Phi2_1*(coefs[i0+1,i1+1,i2+1,k]) + Phi2_2*(coefs[i0+1,i1+1,i2+2,k]) + Phi2_3*(coefs[i0+1,i1+1,i2+3,k])) + \
                                    Phi1_2*(Phi2_0*(coefs[i0+1,i1+2,i2+0,k]) + Phi2_1*(coefs[i0+1,i1+2,i2+1,k]) + Phi2_2*(coefs[i0+1,i1+2,i2+2,k]) + Phi2_3*(coefs[i0+1,i1+2,i2+3,k])) + \
                                    Phi1_3*(Phi2_0*(coefs[i0+1,i1+3,i2+0,k]) + Phi2_1*(coefs[i0+1,i1+3,i2+1,k]) + Phi2_2*(coefs[i0+1,i1+3,i2+2,k]) + Phi2_3*(coefs[i0+1,i1+3,i2+3,k]))) + \
                           dPhi0_2*(Phi1_0*(Phi2_0*(coefs[i0+2,i1+0,i2+0,k]) + Phi2_1*(coefs[i0+2,i1+0,i2+1,k]) + Phi2_2*(coefs[i0+2,i1+0,i2+2,k]) + Phi2_3*(coefs[i0+2,i1+0,i2+3,k])) + \
                                    Phi1_1*(Phi2_0*(coefs[i0+2,i1+1,i2+0,k]) + Phi2_1*(coefs[i0+2,i1+1,i2+1,k]) + Phi2_2*(coefs[i0+2,i1+1,i2+2,k]) + Phi2_3*(coefs[i0+2,i1+1,i2+3,k])) + \
                                    Phi1_2*(Phi2_0*(coefs[i0+2,i1+2,i2+0,k]) + Phi2_1*(coefs[i0+2,i1+2,i2+1,k]) + Phi2_2*(coefs[i0+2,i1+2,i2+2,k]) + Phi2_3*(coefs[i0+2,i1+2,i2+3,k])) + \
                                    Phi1_3*(Phi2_0*(coefs[i0+2,i1+3,i2+0,k]) + Phi2_1*(coefs[i0+2,i1+3,i2+1,k]) + Phi2_2*(coefs[i0+2,i1+3,i2+2,k]) + Phi2_3*(coefs[i0+2,i1+3,i2+3,k]))) + \
                           dPhi0_3*(Phi1_0*(Phi2_0*(coefs[i0+3,i1+0,i2+0,k]) + Phi2_1*(coefs[i0+3,i1+0,i2+1,k]) + Phi2_2*(coefs[i0+3,i1+0,i2+2,k]) + Phi2_3*(coefs[i0+3,i1+0,i2+3,k])) + \
                                    Phi1_1*(Phi2_0*(coefs[i0+3,i1+1,i2+0,k]) + Phi2_1*(coefs[i0+3,i1+1,i2+1,k]) + Phi2_2*(coefs[i0+3,i1+1,i2+2,k]) + Phi2_3*(coefs[i0+3,i1+1,i2+3,k])) + \
                                    Phi1_2*(Phi2_0*(coefs[i0+3,i1+2,i2+0,k]) + Phi2_1*(coefs[i0+3,i1+2,i2+1,k]) + Phi2_2*(coefs[i0+3,i1+2,i2+2,k]) + Phi2_3*(coefs[i0+3,i1+2,i2+3,k])) + \
                                    Phi1_3*(Phi2_0*(coefs[i0+3,i1+3,i2+0,k]) + Phi2_1*(coefs[i0+3,i1+3,i2+1,k]) + Phi2_2*(coefs[i0+3,i1+3,i2+2,k]) + Phi2_3*(coefs[i0+3,i1+3,i2+3,k])))

            dvals[n,1,k] = Phi0_0*(dPhi1_0*(Phi2_0*(coefs[i0+0,i1+0,i2+0,k]) + Phi2_1*(coefs[i0+0,i1+0,i2+1,k]) + Phi2_2*(coefs[i0+0,i1+0,i2+2,k]) + Phi2_3*(coefs[i0+0,i1+0,i2+3,k])) + \
                                   dPhi1_1*(Phi2_0*(coefs[i0+0,i1+1,i2+0,k]) + Phi2_1*(coefs[i0+0,i1+1,i2+1,k]) + Phi2_2*(coefs[i0+0,i1+1,i2+2,k]) + Phi2_3*(coefs[i0+0,i1+1,i2+3,k])) + \
                                   dPhi1_2*(Phi2_0*(coefs[i0+0,i1+2,i2+0,k]) + Phi2_1*(coefs[i0+0,i1+2,i2+1,k]) + Phi2_2*(coefs[i0+0,i1+2,i2+2,k]) + Phi2_3*(coefs[i0+0,i1+2,i2+3,k])) + \
                                   dPhi1_3*(Phi2_0*(coefs[i0+0,i1+3,i2+0,k]) + Phi2_1*(coefs[i0+0,i1+3,i2+1,k]) + Phi2_2*(coefs[i0+0,i1+3,i2+2,k]) + Phi2_3*(coefs[i0+0,i1+3,i2+3,k]))) + \
                           Phi0_1*(dPhi1_0*(Phi2_0*(coefs[i0+1,i1+0,i2+0,k]) + Phi2_1*(coefs[i0+1,i1+0,i2+1,k]) + Phi2_2*(coefs[i0+1,i1+0,i2+2,k]) + Phi2_3*(coefs[i0+1,i1+0,i2+3,k])) + \
                                   dPhi1_1*(Phi2_0*(coefs[i0+1,i1+1,i2+0,k]) + Phi2_1*(coefs[i0+1,i1+1,i2+1,k]) + Phi2_2*(coefs[i0+1,i1+1,i2+2,k]) + Phi2_3*(coefs[i0+1,i1+1,i2+3,k])) + \
                                   dPhi1_2*(Phi2_0*(coefs[i0+1,i1+2,i2+0,k]) + Phi2_1*(coefs[i0+1,i1+2,i2+1,k]) + Phi2_2*(coefs[i0+1,i1+2,i2+2,k]) + Phi2_3*(coefs[i0+1,i1+2,i2+3,k])) + \
                                   dPhi1_3*(Phi2_0*(coefs[i0+1,i1+3,i2+0,k]) + Phi2_1*(coefs[i0+1,i1+3,i2+1,k]) + Phi2_2*(coefs[i0+1,i1+3,i2+2,k]) + Phi2_3*(coefs[i0+1,i1+3,i2+3,k]))) + \
                           Phi0_2*(dPhi1_0*(Phi2_0*(coefs[i0+2,i1+0,i2+0,k]) + Phi2_1*(coefs[i0+2,i1+0,i2+1,k]) + Phi2_2*(coefs[i0+2,i1+0,i2+2,k]) + Phi2_3*(coefs[i0+2,i1+0,i2+3,k])) + \
                                   dPhi1_1*(Phi2_0*(coefs[i0+2,i1+1,i2+0,k]) + Phi2_1*(coefs[i0+2,i1+1,i2+1,k]) + Phi2_2*(coefs[i0+2,i1+1,i2+2,k]) + Phi2_3*(coefs[i0+2,i1+1,i2+3,k])) + \
                                   dPhi1_2*(Phi2_0*(coefs[i0+2,i1+2,i2+0,k]) + Phi2_1*(coefs[i0+2,i1+2,i2+1,k]) + Phi2_2*(coefs[i0+2,i1+2,i2+2,k]) + Phi2_3*(coefs[i0+2,i1+2,i2+3,k])) + \
                                   dPhi1_3*(Phi2_0*(coefs[i0+2,i1+3,i2+0,k]) + Phi2_1*(coefs[i0+2,i1+3,i2+1,k]) + Phi2_2*(coefs[i0+2,i1+3,i2+2,k]) + Phi2_3*(coefs[i0+2,i1+3,i2+3,k]))) + \
                           Phi0_3*(dPhi1_0*(Phi2_0*(coefs[i0+3,i1+0,i2+0,k]) + Phi2_1*(coefs[i0+3,i1+0,i2+1,k]) + Phi2_2*(coefs[i0+3,i1+0,i2+2,k]) + Phi2_3*(coefs[i0+3,i1+0,i2+3,k])) + \
                                   dPhi1_1*(Phi2_0*(coefs[i0+3,i1+1,i2+0,k]) + Phi2_1*(coefs[i0+3,i1+1,i2+1,k]) + Phi2_2*(coefs[i0+3,i1+1,i2+2,k]) + Phi2_3*(coefs[i0+3,i1+1,i2+3,k])) + \
                                   dPhi1_2*(Phi2_0*(coefs[i0+3,i1+2,i2+0,k]) + Phi2_1*(coefs[i0+3,i1+2,i2+1,k]) + Phi2_2*(coefs[i0+3,i1+2,i2+2,k]) + Phi2_3*(coefs[i0+3,i1+2,i2+3,k])) + \
                                   dPhi1_3*(Phi2_0*(coefs[i0+3,i1+3,i2+0,k]) + Phi2_1*(coefs[i0+3,i1+3,i2+1,k]) + Phi2_2*(coefs[i0+3,i1+3,i2+2,k]) + Phi2_3*(coefs[i0+3,i1+3,i2+3,k])))

            dvals[n,2,k] = Phi0_0*(Phi1_0*(dPhi2_0*(coefs[i0+0,i1+0,i2+0,k]) + dPhi2_1*(coefs[i0+0,i1+0,i2+1,k]) + dPhi2_2*(coefs[i0+0,i1+0,i2+2,k]) + dPhi2_3*(coefs[i0+0,i1+0,i2+3,k])) + \
                                   Phi1_1*(dPhi2_0*(coefs[i0+0,i1+1,i2+0,k]) + dPhi2_1*(coefs[i0+0,i1+1,i2+1,k]) + dPhi2_2*(coefs[i0+0,i1+1,i2+2,k]) + dPhi2_3*(coefs[i0+0,i1+1,i2+3,k])) + \
                                   Phi1_2*(dPhi2_0*(coefs[i0+0,i1+2,i2+0,k]) + dPhi2_1*(coefs[i0+0,i1+2,i2+1,k]) + dPhi2_2*(coefs[i0+0,i1+2,i2+2,k]) + dPhi2_3*(coefs[i0+0,i1+2,i2+3,k])) + \
                                   Phi1_3*(dPhi2_0*(coefs[i0+0,i1+3,i2+0,k]) + dPhi2_1*(coefs[i0+0,i1+3,i2+1,k]) + dPhi2_2*(coefs[i0+0,i1+3,i2+2,k]) + dPhi2_3*(coefs[i0+0,i1+3,i2+3,k]))) + \
                           Phi0_1*(Phi1_0*(dPhi2_0*(coefs[i0+1,i1+0,i2+0,k]) + dPhi2_1*(coefs[i0+1,i1+0,i2+1,k]) + dPhi2_2*(coefs[i0+1,i1+0,i2+2,k]) + dPhi2_3*(coefs[i0+1,i1+0,i2+3,k])) + \
                                   Phi1_1*(dPhi2_0*(coefs[i0+1,i1+1,i2+0,k]) + dPhi2_1*(coefs[i0+1,i1+1,i2+1,k]) + dPhi2_2*(coefs[i0+1,i1+1,i2+2,k]) + dPhi2_3*(coefs[i0+1,i1+1,i2+3,k])) + \
                                   Phi1_2*(dPhi2_0*(coefs[i0+1,i1+2,i2+0,k]) + dPhi2_1*(coefs[i0+1,i1+2,i2+1,k]) + dPhi2_2*(coefs[i0+1,i1+2,i2+2,k]) + dPhi2_3*(coefs[i0+1,i1+2,i2+3,k])) + \
                                   Phi1_3*(dPhi2_0*(coefs[i0+1,i1+3,i2+0,k]) + dPhi2_1*(coefs[i0+1,i1+3,i2+1,k]) + dPhi2_2*(coefs[i0+1,i1+3,i2+2,k]) + dPhi2_3*(coefs[i0+1,i1+3,i2+3,k]))) + \
                           Phi0_2*(Phi1_0*(dPhi2_0*(coefs[i0+2,i1+0,i2+0,k]) + dPhi2_1*(coefs[i0+2,i1+0,i2+1,k]) + dPhi2_2*(coefs[i0+2,i1+0,i2+2,k]) + dPhi2_3*(coefs[i0+2,i1+0,i2+3,k])) + \
                                   Phi1_1*(dPhi2_0*(coefs[i0+2,i1+1,i2+0,k]) + dPhi2_1*(coefs[i0+2,i1+1,i2+1,k]) + dPhi2_2*(coefs[i0+2,i1+1,i2+2,k]) + dPhi2_3*(coefs[i0+2,i1+1,i2+3,k])) + \
                                   Phi1_2*(dPhi2_0*(coefs[i0+2,i1+2,i2+0,k]) + dPhi2_1*(coefs[i0+2,i1+2,i2+1,k]) + dPhi2_2*(coefs[i0+2,i1+2,i2+2,k]) + dPhi2_3*(coefs[i0+2,i1+2,i2+3,k])) + \
                                   Phi1_3*(dPhi2_0*(coefs[i0+2,i1+3,i2+0,k]) + dPhi2_1*(coefs[i0+2,i1+3,i2+1,k]) + dPhi2_2*(coefs[i0+2,i1+3,i2+2,k]) + dPhi2_3*(coefs[i0+2,i1+3,i2+3,k]))) + \
                           Phi0_3*(Phi1_0*(dPhi2_0*(coefs[i0+3,i1+0,i2+0,k]) + dPhi2_1*(coefs[i0+3,i1+0,i2+1,k]) + dPhi2_2*(coefs[i0+3,i1+0,i2+2,k]) + dPhi2_3*(coefs[i0+3,i1+0,i2+3,k])) + \
                                   Phi1_1*(dPhi2_0*(coefs[i0+3,i1+1,i2+0,k]) + dPhi2_1*(coefs[i0+3,i1+1,i2+1,k]) + dPhi2_2*(coefs[i0+3,i1+1,i2+2,k]) + dPhi2_3*(coefs[i0+3,i1+1,i2+3,k])) + \
                                   Phi1_2*(dPhi2_0*(coefs[i0+3,i1+2,i2+0,k]) + dPhi2_1*(coefs[i0+3,i1+2,i2+1,k]) + dPhi2_2*(coefs[i0+3,i1+2,i2+2,k]) + dPhi2_3*(coefs[i0+3,i1+2,i2+3,k])) + \
                                   Phi1_3*(dPhi2_0*(coefs[i0+3,i1+3,i2+0,k]) + dPhi2_1*(coefs[i0+3,i1+3,i2+1,k]) + dPhi2_2*(coefs[i0+3,i1+3,i2+2,k]) + dPhi2_3*(coefs[i0+3,i1+3,i2+3,k])))
